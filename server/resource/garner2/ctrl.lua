...
function init_entry(map)
	...
	SetMapEntryTime(map, "2006/10/18/4/0", "0/12/0", "0/0/30", "0/0/45")
end

ChaosArgentAlt = {}
ChaosArgentAltLimit = 1

function Garner2_Init()
	Garner2_Active_Player = 0
	Garner2_Money = 1000000
	Garner2_Wave1 = 0
	Garner2_Wave2 = 0
	Garner2_Wave3 = 0
	Garner2_Wave4 = 0
...
function after_enter_garner2(Player, map_copy)
	local ActName = GetActName(Player)
	if (ChaosArgentAlt[ActName] ~= nil) then
		ChaosArgentAlt[ActName].Num = ChaosArgentAlt[ActName].Num + 1
	end
end
...
function map_copy_run_garner2(map_copy)
	...
	local Message = "Chaos Argent still have survivor(s): "..Survivor.." player(s)!"
	-- Monster waves will spawn only according to map opening time!
	if Hour == 04 or Hour == 16 then
		if Minute == 5 and Second == 0 then
			if Garner2_Wave1 == 0 then
				...
				GMNotice(Message)
				Garner2_Wave1 = Garner2_Wave1 + 1
			end
		end
		if Minute == 10 and Second == 0 then
			if Garner2_Wave2 == 0 then
				...
				GMNotice(Message)
				Garner2_Wave2 = Garner2_Wave2 + 1
			end
		end
		if Minute == 15 and Second == 0 then
			if Garner2_Wave3 == 0 then
				...
				GMNotice(Message)
				Garner2_Wave3 = Garner2_Wave3 + 1
			end
		end
		if Minute == 20 and Second == 0 then
			if Garner2_Wave4 == 0 then
				...
				GMNotice(Message)
				Garner2_Wave4 = Garner2_Wave4 + 1
			end
		end
		if Minute == 25 and Second == 0 then
			if Garner2_Wave5 == 0 then
				...
				GMNotice(Message)
				Garner2_Wave5 = Garner2_Wave5 + 1
			end
		end
		if Minute == 30 and Second == 0 then
			if Garner2_Wave6 == 0 then
				...
				GMNotice(Message)
				Garner2_Wave6 = Garner2_Wave6 + 1
			end
		end
		if Minute == 35 and Second == 0 then
			if Garner2_Wave7 == 0 then
				...
				GMNotice(Message)
				Garner2_Wave7 = Garner2_Wave7 + 1
			end
		end
		if Minute >= 40 and Minute < 45 then
			if Garner2_Tick == 300 then
				Notice("Chaos Argent will be closed in 5 minutes - "..Survivor.." Survivor(s) !")
			end
			if Garner2_Tick == 180 then
				Notice("Chaos Argent will be closed in 3 minutes - "..Survivor.." Survivor(s) !")
			end
			if Garner2_Tick == 120 then
				Notice("Chaos Argent will be closed in 2 minutes - "..Survivor.." Survivor(s) !")
			end
			if Garner2_Tick == 60 then
				Notice("Chaos Argent will be closed in 60 seconds - "..Survivor.." Survivor(s) !")
			end
			Garner2_Tick = Garner2_Tick - 1
		end
	end
end
...
function map_copy_before_close_garner2(map_copy)
	Garner2_Active_Player = GetMapActivePlayer(map_copy)
	if Garner2_Active_Player > 0 then
		DealAllActivePlayerInMap(map_copy, "ChaosArgentRewards")
	end
	Garner2_Init()
end
...
function ChaosArgentRewards(Player)
	if Garner2_Active_Player == 0 then
		return
	end
	local Money = math.floor(Garner2_Money/Garner2_Active_Player)
	if Garner2_Active_Player > 5 then
		AddMoney(Player, 0, Money)
		return
	end
	if Garner2_Active_Player == 1 then
		if GetChaFreeBagGridNum(Player) >= 5 then
			GiveItem(Player, 0, 1032, 1, 4)	
		else
			GiveItemX(Player, 0, 1032, 1, 4)
		end
		AddMoney(Player, 0, Money)
		GMNotice("[Chaos Argent]: Congratulations "..GetChaDefaultName(Player)..", you are the winner of Chaos Argent on this round!")
	else
		if GetChaFreeBagGridNum(Player) >= 5 then
			GiveItem(Player, 0, 1031, 1, 4)
		else
			GiveItemX(Player, 0, 1031, 1, 4)
		end
		AddMoney(Player, 0, Money)
	end
end