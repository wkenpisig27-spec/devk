...
function after_create_entry(entry) 
    ...
    Notice("Announcement: Some players have discovered that on Deep Blue region at ["..posx..","..posy.."] emerges a portal that leads to [Icicle Mirage]. All players beware!") --通知本组服务器的所有玩家
...
function after_player_login_binglang2(entry, player_name)
    map_name, posx, posy, tmap_name = GetMapEntryPosInfo(entry) --取地图入口的位置信息（地图名，坐标，目标地图名）
    ChaNotice(player_name, "Announcement: Some players have discovered that on Deep Blue region at ["..posx..","..posy.."] emerges a portal that leads to [Icicle Mirage]. All players beware!") --通知本组服务器的所有玩家
