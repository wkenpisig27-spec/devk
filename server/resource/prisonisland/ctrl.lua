print("------------------------------------")
print("-- Loading prisonisland file      --")
print("------------------------------------")
...
function map_copy_run_prisonisland(map_copy)
end

function map_copy_run_special_prisonisland(map)
end
...
function map_copy_before_close_prisonisland(map_copy)
end
