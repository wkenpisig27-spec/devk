...
<head>
    ...
    <?= metaTags('Terms of Service', 'Read the Terms of Service for ' . SERVER_NAME) ?>
...
<body>
    ...
    <section class="section">
        <div class="container" style="max-width: 800px;">
            <h1 class="title-section mb-6">Terms of Service</h1>
            <p class="text-muted mb-8">Last updated: <?= date('F j, Y') ?></p>
            
            <div class="card p-8">
                <div class="legal-content">
                    <h2>1. Acceptance of Terms</h2>
                    <p>By accessing and playing <?= e(SERVER_NAME) ?>, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services.</p>
                    
                    <h2>2. Account Registration</h2>
                    <p>To play <?= e(SERVER_NAME) ?>, you must create an account. You agree to:</p>
                    <ul>
                    ...
                    <p>Players are expected to:</p>
                    <ul>
                        <li>Treat other players with respect</li>
                        <li>Not use offensive, hateful, or discriminatory language</li>
                        <li>Not harass, bully, or threaten other players</li>
                        <li>Not impersonate staff members or other players</li>
                        <li>Report bugs and exploits instead of abusing them</li>
                    </ul>
                    
                    <h2>4. Prohibited Activities</h2>
                    <p>The following activities are strictly prohibited:</p>
                    <ul>
                        <li>Using hacks, cheats, bots, or third-party software to gain unfair advantages</li>
                        <li>Exploiting bugs, glitches, or vulnerabilities</li>
                        <li>Real-money trading (RMT) of in-game items or currency</li>
                        <li>Account trading or selling</li>
                        <li>Scamming other players</li>
                        <li>Disrupting server operations or other players' gameplay</li>
                        <li>Advertising other servers or services</li>
                    </ul>
                    
                    <h2>5. Intellectual Property</h2>
                    <p><?= e(SERVER_NAME) ?> is a private server and is not affiliated with the original game developers. All trademarks and copyrights belong to their respective owners. This server is provided for entertainment purposes only.</p>
                    
                    <h2>6. Account Termination</h2>
                    <p>We reserve the right to suspend or terminate accounts that violate these terms without prior notice. Banned players are not entitled to refunds for any purchases made.</p>
                    
                    <h2>7. Service Availability</h2>
                    <p>We strive to maintain server uptime but do not guarantee uninterrupted service. We may perform maintenance, updates, or modifications at any time without prior notice.</p>
                    
                    <h2>8. Limitation of Liability</h2>
                    <p><?= e(SERVER_NAME) ?> is provided "as is" without warranties of any kind. We are not liable for any damages arising from the use of our services, including but not limited to data loss, account issues, or service interruptions.</p>
                    
                    <h2>9. Changes to Terms</h2>
                    <p>We may update these terms at any time. Continued use of the service after changes constitutes acceptance of the new terms.</p>
                    
                    <h2>10. Contact</h2>
                    <p>For questions about these terms, please contact us through our <a href="https://discord.com/invite/NHmFsuMpS5" target="_blank" class="text-gold">Discord server</a>.</p>
                </div>
            </div>
        </div>
    </section>
