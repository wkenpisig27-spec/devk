...
typedef enum PARTICIPANT_TYPED_INFO { PTI_CANONICALNAME = 0,
...
typedef enum PARTICIPANT_EVENT { PE_NEW_PARTICIPANT = 0,
...
/* interface __MIDL_itf_ipmsp_0494 */
/* [local] */
...
typedef enum tagStreamConfigCapsType { AudioStreamConfigCaps = 0,
...
typedef enum tagTAPIControlFlags { TAPIControl_Flags_None = 0,
								   TAPIControl_Flags_Auto = 0x1,
								   TAPIControl_Flags_Manual = 0x2
} TAPIControlFlags;

extern RPC_IF_HANDLE __MIDL_itf_ipmsp_0494_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_ipmsp_0494_v0_0_s_ifspec;
...
typedef enum tagStreamQualityProperty { StreamQuality_MaxBitrate = 0,
...
typedef enum tagCallQualityProperty { CallQuality_ControlInterval = 0,
...
typedef enum tagAudioDeviceProperty { AudioDevice_DuplexMode = 0,
...
typedef enum tagAudioSettingsProperty { AudioSettings_SignalLevel = 0,
...
/* interface __MIDL_itf_ipmsp_0500 */
/* [local] */
...
extern RPC_IF_HANDLE __MIDL_itf_ipmsp_0500_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_ipmsp_0500_v0_0_s_ifspec;
