...
/* interface __MIDL_itf_autosvcs_0298 */
/* [local] */
...
extern RPC_IF_HANDLE __MIDL_itf_autosvcs_0298_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_autosvcs_0298_v0_0_s_ifspec;
...
/* interface __MIDL_itf_autosvcs_0319 */
/* [local] */

typedef /* [public][public] */
	enum __MIDL___MIDL_itf_autosvcs_0319_0001 { TRKCOLL_PROCESSES = 0,
												TRKCOLL_APPLICATIONS = TRKCOLL_PROCESSES + 1,
												TRKCOLL_COMPONENTS = TRKCOLL_APPLICATIONS + 1
	} TRACKING_COLL_TYPE;

extern RPC_IF_HANDLE __MIDL_itf_autosvcs_0319_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_autosvcs_0319_v0_0_s_ifspec;
...
typedef enum tagCOMPLUS_APPTYPE { APPTYPE_UNKNOWN = 0xffffffff,
								  APPTYPE_SERVER = 1,
								  APPTYPE_LIBRARY = 0,
								  APPTYPE_SWC = 2
} COMPLUS_APPTYPE;
...
/* interface __MIDL_itf_autosvcs_0341 */
/* [local] */
...
extern RPC_IF_HANDLE __MIDL_itf_autosvcs_0341_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_autosvcs_0341_v0_0_s_ifspec;
...
/* interface __MIDL_itf_autosvcs_0342 */
/* [local] */
...
/* interface __MIDL_itf_autosvcs_0343 */
/* [local] */
...
/* interface __MIDL_itf_autosvcs_0361 */
/* [local] */

typedef enum tagTransactionVote { TxCommit = 0,
								  TxAbort = TxCommit + 1
} TransactionVote;

extern RPC_IF_HANDLE __MIDL_itf_autosvcs_0361_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_autosvcs_0361_v0_0_s_ifspec;
...
/* interface __MIDL_itf_autosvcs_0365 */
/* [local] */
...
extern RPC_IF_HANDLE __MIDL_itf_autosvcs_0365_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_autosvcs_0365_v0_0_s_ifspec;
...
/* interface __MIDL_itf_autosvcs_0368 */
/* [local] */

#ifndef _tagCrmTransactionState_
#define _tagCrmTransactionState_
typedef enum tagCrmTransactionState { TxState_Active = 0,
...
/* interface __MIDL_itf_autosvcs_0372 */
/* [local] */

typedef enum tagCSC_InheritanceConfig { CSC_Inherit = 0,
										CSC_Ignore = CSC_Inherit + 1
} CSC_InheritanceConfig;

typedef enum tagCSC_ThreadPool { CSC_ThreadPoolNone = 0,
								 CSC_ThreadPoolInherit = CSC_ThreadPoolNone + 1,
								 CSC_STAThreadPool = CSC_ThreadPoolInherit + 1,
								 CSC_MTAThreadPool = CSC_STAThreadPool + 1
} CSC_ThreadPool;

typedef enum tagCSC_Binding { CSC_NoBinding = 0,
							  CSC_BindToPoolThread = CSC_NoBinding + 1
} CSC_Binding;

typedef enum tagCSC_TransactionConfig { CSC_NoTransaction = 0,
...
typedef enum tagCSC_SynchronizationConfig { CSC_NoSynchronization = 0,
...
typedef enum tagCSC_TrackerConfig { CSC_DontUseTracker = 0,
									CSC_UseTracker = CSC_DontUseTracker + 1
} CSC_TrackerConfig;

typedef enum tagCSC_PartitionConfig { CSC_NoPartition = 0,
									  CSC_InheritPartition = CSC_NoPartition + 1,
									  CSC_NewPartition = CSC_InheritPartition + 1
} CSC_PartitionConfig;

typedef enum tagCSC_IISIntrinsicsConfig { CSC_NoIISIntrinsics = 0,
										  CSC_InheritIISIntrinsics = CSC_NoIISIntrinsics + 1
} CSC_IISIntrinsicsConfig;

typedef enum tagCSC_COMTIIntrinsicsConfig { CSC_NoCOMTIIntrinsics = 0,
											CSC_InheritCOMTIIntrinsics = CSC_NoCOMTIIntrinsics + 1
} CSC_COMTIIntrinsicsConfig;

typedef enum tagCSC_SxsConfig { CSC_NoSxs = 0,
								CSC_InheritSxs = CSC_NoSxs + 1,
								CSC_NewSxs = CSC_InheritSxs + 1
} CSC_SxsConfig;

extern RPC_IF_HANDLE __MIDL_itf_autosvcs_0372_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_autosvcs_0372_v0_0_s_ifspec;
...
public:
	virtual HRESULT STDMETHODCALLTYPE Initialize(
		/* [in] */ IUnknown * pUnkAD,
		/* [in] */ HRESULT(STDMETHODCALLTYPE __MIDL_0028)(void* pv),
		/* [in] */ void* pPool) = 0;

	virtual HRESULT STDMETHODCALLTYPE DoCallback(
		/* [in] */ IUnknown * pUnkAD,
		/* [in] */ HRESULT(STDMETHODCALLTYPE __MIDL_0029)(void* pv),
		/* [in] */ void* pPool) = 0;
};
...
public:
	virtual HRESULT STDMETHODCALLTYPE GetModules(
		...
		/* [retval][out] */ SAFEARRAY * *pModules) = 0;
};
...
/* interface __MIDL_itf_autosvcs_0397 */
/* [local] */

extern RPC_IF_HANDLE __MIDL_itf_autosvcs_0397_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_autosvcs_0397_v0_0_s_ifspec;
...
/* interface __MIDL_itf_autosvcs_0398 */
/* [local] */

EXTERN_C HRESULT __stdcall MTSCreateActivity(REFIID riid, void** ppobj);

extern RPC_IF_HANDLE __MIDL_itf_autosvcs_0398_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_autosvcs_0398_v0_0_s_ifspec;
...
typedef /* [public][helpcontext][helpstring] */
	enum __MIDL___MIDL_itf_autosvcs_0403_0001 { mtsErrCtxAborted = 0x8004e002,
...
typedef /* [public] */
	enum __MIDL___MIDL_itf_autosvcs_0403_0002 { LockSetGet = 0,
												LockMethod = LockSetGet + 1
	} LockModes;

typedef /* [public] */
	enum __MIDL___MIDL_itf_autosvcs_0403_0003 { Standard = 0,
												Process = Standard + 1
	} ReleaseModes;

#ifndef _tagCrmFlags_
#define _tagCrmFlags_
typedef enum tagCRMFLAGS { CRMFLAG_FORGETTARGET = 0x1,
...
typedef enum tagCRMREGFLAGS { CRMREGFLAG_PREPAREPHASE = 0x1,
