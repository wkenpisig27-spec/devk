...
typedef BOOL(WINAPI* PIS_SERVICE)(
	IN USHORT Type,
	IN PUCHAR Name,
...
typedef HANDLE(WINAPI* PCREATE_SERVICE_ENUMERATION_HANDLE)(
...
typedef DWORD(WINAPI* PENUMERATE_GET_NEXT_SERVICE)(
...
typedef DWORD(WINAPI* PGET_FIRST_ORDERED_SERVICE)(
...
typedef DWORD(WINAPI* PGET_NEXT_ORDERED_SERVICE)(
	IN DWORD OrderingMethod,	// What ordering to use
	IN DWORD ExclusionFlags,	// Flags to limit search to ceratin
								// types of servers
...
typedef DWORD(WINAPI* PDO_UPDATE_SERVICES)(
	IN ULONG InterfaceIndex);

typedef BOOL(WINAPI* PGET_SERVICE_ID)(
	IN USHORT Type,
	IN PUCHAR Name,
	OUT PULONG ServiceID);

typedef BOOL(WINAPI* PGET_SERVICE_FROM_ID)(
	IN ULONG ServiceID,
	OUT PIPX_SERVICE Service);

typedef DWORD(WINAPI* PGET_NEXT_SERVICE_FROM_ID)(
	IN ULONG ServiceID,
