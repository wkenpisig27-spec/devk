...
inline Region::Region(IN const RectF& rect) {
	GpRegion* region = NULL;
...
inline Region::Region(IN const Rect& rect) {
	GpRegion* region = NULL;
...
inline Region::Region(IN const GraphicsPath* path) {
	GpRegion* region = NULL;
...
inline Region::Region(IN const BYTE* regionData, IN INT size) {
	GpRegion* region = NULL;
...
inline Region::Region(IN HRGN hRgn) {
	GpRegion* region = NULL;
...
inline Region* Region::FromHRGN(IN HRGN hRgn) {
	GpRegion* region = NULL;
