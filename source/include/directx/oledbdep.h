...
enum DBPROPENUM25_DEPRECATED { DBPROP_ICommandCost = 0x8dL,
...
enum DBREASONENUM25 { DBREASON_ROWSET_ROWSADDED = DBREASON_ROW_ASYNCHINSERT + 1,
...
enum DBWATCHNOTIFYENUM { DBWATCHNOTIFY_ROWSCHANGED = 1,
...
enum DBWATCHMODEENUM { DBWATCHMODE_ALL = 0x1,
...
enum DBROWCHANGEKINDENUM { DBROWCHANGEKIND_INSERT = 0,
...
enum DBRESOURCEKINDENUM { DBRESOURCE_INVALID = 0,
						  DBRESOURCE_TOTAL = 1,
						  DBRESOURCE_CPU = 2,
						  DBRESOURCE_MEMORY = 3,
						  DBRESOURCE_DISK = 4,
...
enum DBCOSTUNITENUM { DBUNIT_INVALID = 0,
					  DBUNIT_WEIGHT = 0x1,
					  DBUNIT_PERCENT = 0x2,
					  DBUNIT_MAXIMUM = 0x4,
					  DBUNIT_MINIMUM = 0x8,
...
enum DBEXECLIMITSENUM { DBEXECLIMITS_ABORT = 1,
						DBEXECLIMITS_STOP = 2,
