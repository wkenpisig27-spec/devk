...
typedef /* [public] */
	enum _ATTRIBUTEID { ATTRIBUTE_UNDEFINED = 0,
						...
						IAS_ATTRIUBTE_EXTENSION_STATE = IAS_ATTRIBUTE_ALLOWED_CERTIFICATE_EKU + 1,
						IAS_ATTRIBUTE_GENERATE_SESSION_TIMEOUT = IAS_ATTRIUBTE_EXTENSION_STATE + 1,
...
typedef /* [public] */
	enum _NEW_LOG_FILE_FREQUENCY { IAS_LOGGING_UNLIMITED_SIZE = 0,
...
typedef /* [public] */
	enum _AUTHENTICATION_TYPE { IAS_AUTH_INVALID = 0,
...
typedef /* [public] */
	enum _ATTRIBUTESYNTAX { IAS_SYNTAX_BOOLEAN = 1,
...
typedef /* [public] */
	enum _ATTRIBUTERESTRICTIONS { MULTIVALUED = 0x1,
...
typedef /* [public] */
	enum _IASCOMMONPROPERTIES { PROPERTY_SDO_RESERVED = 0,
...
typedef /* [public] */
	enum _USERPROPERTIES { PROPERTY_USER_CALLING_STATION_ID = PROPERTY_SDO_START,
...
typedef /* [public] */
	enum _DICTIONARYPROPERTIES { PROPERTY_DICTIONARY_ATTRIBUTES_COLLECTION = PROPERTY_SDO_START,
								 PROPERTY_DICTIONARY_LOCATION = PROPERTY_DICTIONARY_ATTRIBUTES_COLLECTION + 1
	} DICTIONARYPROPERTIES;

typedef /* [public] */
	enum _ATTRIBUTEPROPERTIES { PROPERTY_ATTRIBUTE_ID = PROPERTY_SDO_START,
...
typedef /* [public] */
	enum _IASPROPERTIES { PROPERTY_IAS_RADIUSSERVERGROUPS_COLLECTION = PROPERTY_SDO_START,
...
typedef /* [public] */
	enum _CLIENTPROPERTIES { PROPERTY_CLIENT_REQUIRE_SIGNATURE = PROPERTY_SDO_START,
...
typedef /* [public] */
	enum _VENDORPROPERTIES { PROPERTY_NAS_VENDOR_ID = PROPERTY_SDO_START
	} VENDORPROPERTIES;

typedef /* [public] */
	enum _PROFILEPROPERTIES { PROPERTY_PROFILE_ATTRIBUTES_COLLECTION = PROPERTY_SDO_START
	} PROFILEPROPERTIES;

typedef /* [public] */
	enum _POLICYPROPERTIES { PROPERTY_POLICY_CONSTRAINT = PROPERTY_SDO_START,
...
typedef /* [public] */
	enum _CONDITIONPROPERTIES { PROPERTY_CONDITION_TEXT = PROPERTY_SDO_START
	} CONDITIONPROPERTIES;

typedef /* [public] */
	enum _RADIUSSERVERGROUPPROPERTIES { PROPERTY_RADIUSSERVERGROUP_SERVERS_COLLECTION = PROPERTY_SDO_START
	} RADIUSSERVERGROUPPROPERTIES;

typedef /* [public] */
	enum _RADIUSSERVERPROPERTIES { PROPERTY_RADIUSSERVER_AUTH_PORT = PROPERTY_SDO_START,
...
typedef /* [public] */
	enum _IASCOMPONENTPROPERTIES { PROPERTY_COMPONENT_ID = PROPERTY_SDO_START,
...
typedef /* [public] */
	enum _PROTOCOLPROPERTIES { PROPERTY_PROTOCOL_REQUEST_HANDLER = PROPERTY_COMPONENT_START,
							   PROPERTY_PROTOCOL_START = PROPERTY_PROTOCOL_REQUEST_HANDLER + 1
	} PROTOCOLPROPERTIES;

typedef /* [public] */
	enum _RADIUSPROPERTIES { PROPERTY_RADIUS_ACCOUNTING_PORT = PROPERTY_PROTOCOL_START,
...
typedef /* [public] */
	enum _NTEVENTLOGPROPERTIES { PROPERTY_EVENTLOG_LOG_APPLICATION_EVENTS = PROPERTY_COMPONENT_START,
...
typedef /* [public] */
	enum _NAMESPROPERTIES { PROPERTY_NAMES_REALMS = PROPERTY_COMPONENT_START
	} NAMESPROPERTIES;

typedef /* [public] */
	enum _NTSAMPROPERTIES { PROPERTY_NTSAM_ALLOW_LM_AUTHENTICATION = PROPERTY_COMPONENT_START
	} NTSAMPROPERTIES;

typedef /* [public] */
	enum _ACCOUNTINGPROPERTIES { PROPERTY_ACCOUNTING_LOG_ACCOUNTING = PROPERTY_COMPONENT_START,
...
typedef /* [public] */
	enum _EAPWRAPPROPERTIES { PROPERTY_EAP_SESSION_TIMEOUT = PROPERTY_COMPONENT_START,
							  PROPERTY_EAP_MAX_SESSIONS = PROPERTY_EAP_SESSION_TIMEOUT + 1
	} EAPWRAPPROPERTIES;

typedef /* [public] */
	enum _NAPPROPERTIES { PROPERTY_NAP_POLICIES_COLLECTION = PROPERTY_COMPONENT_START
	} NAPPROPERTIES;

typedef /* [public] */
	enum _RADIUSPROXYPROPERTIES { PROPERTY_RADIUSPROXY_SERVERGROUPS = PROPERTY_COMPONENT_START
	} RADIUSPROXYPROPERTIES;

typedef /* [public] */
	enum _SERVICE_TYPE { SERVICE_TYPE_IAS = 0,
						 SERVICE_TYPE_RAS = SERVICE_TYPE_IAS + 1,
						 SERVICE_TYPE_MAX = SERVICE_TYPE_RAS + 1
	} SERVICE_TYPE;

typedef /* [public] */
	enum _IASOSTYPE { SYSTEM_TYPE_NT4_WORKSTATION = 0,
...
typedef /* [public] */
	enum _DOMAINTYPE { DOMAIN_TYPE_NONE = 0,
...
typedef /* [public] */
	enum _IASDATASTORE { DATA_STORE_LOCAL = 0,
