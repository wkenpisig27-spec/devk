...
DECLARE_INTERFACE_(IMixerPinConfig, IUnknown) {
	...
	(THIS_
		 IN DWORD dwBlendingParameter) PURE;
...
DECLARE_INTERFACE_(IMixerPinConfig2, IMixerPinConfig) {
	...
	STDMETHOD(GetOverlaySurfaceColorControls)
	(THIS_
		 OUT LPDDCOLORCONTROL pColorControl) PURE;
};
