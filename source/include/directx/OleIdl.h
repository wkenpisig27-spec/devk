...
typedef enum tagUSERCLASSTYPE { USERCLASSTYPE_FULL = 1,
								USERCLASSTYPE_SHORT = 2,
								USERCLASSTYPE_APPNAME = 3
} USERCLASSTYPE;

typedef enum tagOLEMISC { OLEMISC_RECOMPOSEONRESIZE = 0x1,
...
typedef enum tagOLECLOSE { OLECLOSE_SAVEIFDIRTY = 0,
						   OLECLOSE_NOSAVE = 1,
...
typedef enum tagOLERENDER { OLERENDER_NONE = 0,
							OLERENDER_DRAW = 1,
							OLERENDER_FORMAT = 2,
							OLERENDER_ASIS = 3
} OLERENDER;
...
typedef enum tagOLEUPDATE { OLEUPDATE_ALWAYS = 1,
							OLEUPDATE_ONCALL = 3
} OLEUPDATE;
...
typedef enum tagOLELINKBIND { OLELINKBIND_EVENIFCLASSDIFF = 1
} OLELINKBIND;
...
typedef enum tagBINDSPEED { BINDSPEED_INDEFINITE = 1,
