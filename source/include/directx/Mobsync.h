...
typedef enum _tagSYNCMGRFLAG { SYNCMGRFLAG_CONNECT = 0x1,
...
typedef enum _tagSYNCMGRHANDLERFLAGS { SYNCMGRHANDLER_HASPROPERTIES = 0x1,
...
typedef enum _tagSYNCMGRSTATUS { SYNCMGRSTATUS_STOPPED = 0,
...
typedef enum _tagSYNCMGRLOGLEVEL { SYNCMGRLOGLEVEL_INFORMATION = 0x1,
...
typedef enum _tagSYNCMGRERRORFLAGS { SYNCMGRERRORFLAG_ENABLEJUMPTEXT = 0x1
} SYNCMGRERRORFLAGS;
...
typedef enum _tagSYNCMGRITEMFLAGS { SYNCMGRITEM_HASPROPERTIES = 0x1,
...
typedef enum _tagSYNCMGRINVOKEFLAGS { SYNCMGRINVOKE_STARTSYNC = 0x2,
...
typedef enum _tagSYNCMGRREGISTERFLAGS { SYNCMGRREGISTERFLAG_CONNECT = 0x1,
...
/* interface __MIDL_itf_mobsync_0122 */
/* [local] */
