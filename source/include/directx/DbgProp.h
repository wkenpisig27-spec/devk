...
typedef enum tagOBJECT_ATTRIB_FLAG { OBJECT_ATTRIB_NO_ATTRIB = 0,
...
typedef enum tagPROP_INFO_FLAGS { PROP_INFO_NAME = 0x1,
								  PROP_INFO_TYPE = 0x2,
								  PROP_INFO_VALUE = 0x4,
...
typedef enum tagEX_PROP_INFO_FLAGS { EX_PROP_INFO_ID = 0x100,
