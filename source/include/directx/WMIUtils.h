...
typedef /* [v1_enum] */
	enum tag_WBEM_PATH_STATUS_FLAG { WBEMPATH_INFO_ANON_LOCAL_MACHINE = 0x1,
...
typedef /* [v1_enum] */
	enum tag_WBEM_PATH_CREATE_FLAG { WBEMPATH_CREATE_ACCEPT_RELATIVE = 0x1,
...
typedef /* [v1_enum] */
	enum tag_WBEM_GET_TEXT_FLAGS { WBEMPATH_COMPRESSED = 0x1,
...
typedef /* [v1_enum] */
	enum tag_WBEM_GET_KEY_FLAGS { WBEMPATH_TEXT = 0x1,
...
typedef /* [public] */
	enum __MIDL___MIDL_itf_wmiutils_0116_0001 { WMIQ_ANALYSIS_RPN_SEQUENCE = 0x1,
...
typedef /* [public] */
	enum __MIDL___MIDL_itf_wmiutils_0116_0002 { WMIQ_RPN_TOKEN_EXPRESSION = 1,
...
typedef /* [public] */
	enum __MIDL___MIDL_itf_wmiutils_0116_0003 { WMIQ_ASSOCQ_ASSOCIATORS = 0x1,
...
typedef enum tag_WMIQ_LANGUAGE_FEATURES { WMIQ_LF1_BASIC_SELECT = 1,
...
typedef enum tag_WMIQ_RPNQ_FEATURE { WMIQ_RPNF_WHERE_CLAUSE_PRESENT = 0x1,
