...
typedef enum TX_MISC_CONSTANTS { MAX_TRAN_DESC = 40
} TX_MISC_CONSTANTS;
...
typedef enum ISOLATIONLEVEL { ISOLATIONLEVEL_UNSPECIFIED = 0xffffffff,
...
typedef enum ISOFLAG { ISOFLAG_RETAIN_COMMIT_DC = 1,
...
typedef enum XACTTC { XACTTC_NONE = 0,
...
typedef enum XACTRM { XACTRM_OPTIMISTICLASTWINS = 1,
					  XACTRM_NOREADONLYPREPARES = 2
} XACTRM;

typedef enum XACTCONST { XACTCONST_TIMEOUTINFINITE = 0
} XACTCONST;

typedef enum XACTHEURISTIC { XACTHEURISTIC_ABORT = 1,
							 XACTHEURISTIC_COMMIT = 2,
							 XACTHEURISTIC_DAMAGE = 3,
							 XACTHEURISTIC_DANGER = 4
} XACTHEURISTIC;

typedef enum XACTSTAT { XACTSTAT_NONE = 0,
