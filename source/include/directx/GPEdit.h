...
DECLARE_INTERFACE_(IGPEInformation, IUnknown) {
	...
	STDMETHOD(GetName)
	(THIS_ LPOLESTR pszName, int cchMaxLength) PURE;
	...
	STDMETHOD(GetRegistryKey)
	(THIS_ DWORD dwSection, HKEY * hKey) PURE;
	...
	STDMETHOD(GetDSPath)
	(THIS_ DWORD dwSection, LPOLESTR pszPath, int cchMaxPath) PURE;
	...
	STDMETHOD(GetType)
	(THIS_ GROUP_POLICY_OBJECT_TYPE * gpoType) PURE;
	...
	STDMETHOD(GetHint)
	(THIS_ GROUP_POLICY_HINT_TYPE * gpHint) PURE;
	...
	STDMETHOD(PolicyChanged)
	(THIS_ BOOL bMachine, BOOL bAdd, GUID * pGuidExtension, GUID * pGuidSnapin) PURE;
};
...
DECLARE_INTERFACE_(IGroupPolicyObject, IUnknown) {
	...
	STDMETHOD(New)
	(THIS_ LPOLESTR pszDomainName, LPOLESTR pszDisplayName,
	 DWORD dwFlags) PURE;
	...
	STDMETHOD(OpenDSGPO)
	(THIS_ LPOLESTR pszPath, DWORD dwFlags) PURE;
	...
	STDMETHOD(OpenRemoteMachineGPO)
	(THIS_ LPOLESTR pszComputerName, DWORD dwFlags) PURE;
	...
	STDMETHOD(Save)
	(THIS_ BOOL bMachine, BOOL bAdd, GUID * pGuidExtension, GUID * pGuid) PURE;
	...
	STDMETHOD(GetPath)
	(THIS_ LPOLESTR pszPath, int cchMaxPath) PURE;
	...
	(THIS_ DWORD dwOptions, DWORD dwMask) PURE;
	...
	STDMETHOD(GetPropertySheetPages)
	(THIS_ HPROPSHEETPAGE * *hPages, UINT * uPageCount) PURE;
};
...
DECLARE_INTERFACE_(IRSOPInformation, IUnknown) {
	...
	(THIS_ DWORD dwSection, LPOLESTR pszName, int cchMaxLength) PURE;
	...
	STDMETHOD(GetEventLogEntryText)
	(THIS_ LPOLESTR pszEventSource, LPOLESTR pszEventLogName,
