...
typedef VOID (*PFN_IO_COMPLETION)(
...
//		DOT stuffing.
//
typedef HANDLE(__stdcall* FCACHE_RICHCREATE_CALLBACK)(
	IN LPSTR lpstrName,
	IN LPVOID lpvData,
	OUT DWORD* cbFileSize,
	OUT DWORD* cbFileSizeHigh,
...
//
FILEHC_EXPORT
BOOL __stdcall InitializeCache();
...
//
FILEHC_EXPORT
BOOL __stdcall TerminateCache();

//
//	Associate a file with an async context !
//
FILEHC_EXPORT
PFIO_CONTEXT __stdcall AssociateFile(HANDLE hFile);
...
//
FILEHC_EXPORT
PFIO_CONTEXT __stdcall AssociateFileEx(HANDLE hFile,
									   BOOL fStoreWithDots,
...
//
FILEHC_EXPORT
void __stdcall AddRefContext(PFIO_CONTEXT);
...
//
FILEHC_EXPORT
void __stdcall ReleaseContext(PFIO_CONTEXT);
...
//
FILEHC_EXPORT
BOOL __stdcall CloseNonCachedFile(PFIO_CONTEXT);
...
//
FILEHC_EXPORT
FIO_CONTEXT* __stdcall CacheCreateFile(IN LPSTR lpstrName,
...
//
FILEHC_EXPORT
FIO_CONTEXT* __stdcall CacheRichCreateFile(IN LPSTR lpstrName,
...
//
FILEHC_EXPORT
void __stdcall CacheRemoveFiles(IN LPSTR lpstrName,
...
//
FILEHC_EXPORT
BOOL __stdcall InsertFile(IN LPSTR lpstrName,
...
//
FILEHC_EXPORT
DWORD __stdcall GetFileSizeFromContext(IN FIO_CONTEXT* pContext,
...
//
typedef int(__stdcall* CACHE_KEY_COMPARE)(IN DWORD cbKey1,
										  IN LPBYTE lpbKey1,
										  IN DWORD cbKey2,
										  IN LPBYTE lpbKey2);
...
//
typedef DWORD(__stdcall* CACHE_KEY_HASH)(IN LPBYTE lpbKey,
										 IN DWORD cbKey);
...
//
//
typedef BOOL(__stdcall* CACHE_READ_CALLBACK)(IN DWORD cb,
											 IN LPBYTE lpb,
...
//
typedef void(__stdcall* CACHE_DESTROY_CALLBACK)(IN DWORD cb,
												IN LPBYTE lpb);
...
//
typedef BOOL(WINAPI* CACHE_ACCESS_CHECK)(IN PSECURITY_DESCRIPTOR pSecurityDescriptor,
...
//
FILEHC_EXPORT
PNAME_CACHE_CONTEXT __stdcall FindOrCreateNameCache(
	//
...
//
FILEHC_EXPORT
long __stdcall ReleaseNameCache(
	//
	//	Must not be NULL !
	//
...
//
FILEHC_EXPORT
BOOL __stdcall SetNameCacheSecurityFunction(
	//
	//	Must not be NULL !
	//
	PNAME_CACHE_CONTEXT pNameCache,
...
//
FILEHC_EXPORT
BOOL __stdcall AssociateContextWithName(
	//
	//	The name cache the client wishes to use !
	//
	PNAME_CACHE_CONTEXT pNameCache,
...
//
FILEHC_EXPORT
FIO_CONTEXT* __stdcall ProduceDotStuffedContext(IN FIO_CONTEXT* pContext,
												IN LPSTR lpstrName,
...
//
FILEHC_EXPORT
BOOL __stdcall ProduceDotStuffedContextInContext(
...
//
FILEHC_EXPORT
BOOL __stdcall GetIsFileDotTerminated(IN FIO_CONTEXT* pContext);

//
//	Set whether the file has a terminating 'CRLF.CRLF' sequence !
//
FILEHC_EXPORT
void __stdcall SetIsFileDotTerminated(IN FIO_CONTEXT* pContext,
...
//
FILEHC_EXPORT
BOOL __stdcall SetDotStuffingOnWrites(IN FIO_CONTEXT* pContext,
									  //
...
//
FILEHC_EXPORT
BOOL __stdcall SetDotScanningOnWrites(IN FIO_CONTEXT* pContext,
									  IN BOOL fEnable);
...
//
FILEHC_EXPORT
void __stdcall CompleteDotStuffingOnWrites(IN FIO_CONTEXT* pContext,
										   IN BOOL fStripDots);
...
//
FILEHC_EXPORT
BOOL __stdcall SetDotScanningOnReads(IN FIO_CONTEXT* pContext,
									 IN BOOL fEnable);
...
//
FILEHC_EXPORT
BOOL __stdcall GetDotStuffState(IN FIO_CONTEXT* pContext,
								IN BOOL fReads,
								OUT BOOL* pfStuffed,
								OUT BOOL* pfStoredWithDots);
...
//
FILEHC_EXPORT
void __stdcall SetDotStuffState(IN FIO_CONTEXT* pContext,
								//
