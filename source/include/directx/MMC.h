...
typedef enum _MMC_CONTROL_TYPE { TOOLBAR = 0,
...
typedef enum _MMC_BUTTON_STATE { ENABLED = 0x1,
								 CHECKED = 0x2,
								 HIDDEN = 0x4,
								 INDETERMINATE = 0x8,
								 BUTTONPRESSED = 0x10
...
typedef enum _MMC_SCOPE_ITEM_STATE { MMC_SCOPE_ITEM_STATE_NORMAL = 0x1,
...
typedef enum _MMC_MENU_COMMAND_IDS { MMCC_STANDARD_VIEW_SELECT = -1
...
typedef enum _MMC_FILTER_TYPE { MMC_STRING_FILTER = 0,
								MMC_INT_FILTER = 0x1,
...
typedef enum _MMC_FILTER_CHANGE_CODE { MFCC_DISABLE = 0,
									   MFCC_ENABLE = 1,
									   MFCC_VALUE_CHANGE = 2
...
#endif
typedef enum _DATA_OBJECT_TYPES { CCT_SCOPE = 0x8000,
								  CCT_RESULT = 0x8001,
...
/* interface __MIDL_itf_mmc_0121 */
/* [local] */

enum __MIDL___MIDL_itf_mmc_0121_0001 { CCM_INSERTIONPOINTID_MASK_SPECIAL = 0xffff0000,
...
enum __MIDL___MIDL_itf_mmc_0121_0002 { CCM_INSERTIONALLOWED_TOP = 1L << (CCM_INSERTIONPOINTID_PRIMARY_TOP & CCM_INSERTIONPOINTID_MASK_FLAGINDEX),
...
enum __MIDL___MIDL_itf_mmc_0121_0003 { CCM_COMMANDID_MASK_RESERVED = 0xffff0000
};

enum __MIDL___MIDL_itf_mmc_0121_0004 { CCM_SPECIAL_SEPARATOR = 0x1,
...
typedef enum _MMC_TASK_DISPLAY_TYPE { MMC_TASK_DISPLAY_UNINITIALIZED = 0,
...
typedef enum _MMC_ACTION_TYPE { MMC_ACTION_UNINITIALIZED = -1,
...
typedef enum tagIconIdentifier { Icon_None = 0,
								 Icon_Error = 32513,
								 Icon_Question = 32514,
								 Icon_Warning = 32515,
...
/* interface __MIDL_itf_mmc_0151 */
/* [local] */

#endif // MMC_VER >= 0x0120
#if (MMC_VER >= 0x0200)
typedef enum _MMC_VIEW_TYPE { MMC_VIEW_TYPE_LIST = 0,
