...
typedef enum DIRECTORY_TYPE { DT_NTDS = 1,
							  DT_ILS = 2
} DIRECTORY_TYPE;

typedef enum DIRECTORY_OBJECT_TYPE { OT_CONFERENCE = 1,
									 OT_USER = 2
} DIRECTORY_OBJECT_TYPE;

typedef enum RND_ADVERTISING_SCOPE { RAS_LOCAL = 1,
									 RAS_SITE = 2,
									 RAS_REGION = 3,
									 RAS_WORLD = 4
...
/* interface __MIDL_itf_rend_0502 */
/* [local] */
...
extern RPC_IF_HANDLE __MIDL_itf_rend_0502_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_rend_0502_v0_0_s_ifspec;
