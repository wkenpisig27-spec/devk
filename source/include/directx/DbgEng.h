...
DECLARE_INTERFACE_(IDebugBreakpoint, IUnknown) {
	...
	(
		THIS_
			OUT PULONG64 Offset) PURE;
	STDMETHOD(SetOffset)
	(
		THIS_
			IN ULONG64 Offset) PURE;
	...
	(
		...
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG CommandSize) PURE;
	STDMETHOD(SetCommand)
	(
		THIS_
			IN PCSTR Command) PURE;
	...
	(
		THIS_
			OUT OPTIONAL PSTR Buffer,
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG ExpressionSize) PURE;
	STDMETHOD(SetOffsetExpression)
	(
		THIS_
			IN PCSTR Expression) PURE;

	STDMETHOD(GetParameters)
	(
		THIS_
			OUT PDEBUG_BREAKPOINT_PARAMETERS Params) PURE;
};
...
DECLARE_INTERFACE_(IDebugClient, IUnknown) {
	...
	(
		THIS_
			IN ULONG Flags,
		IN OPTIONAL PCSTR ConnectOptions) PURE;
	STDMETHOD(GetKernelConnectionOptions)
	(
		THIS_
			OUT OPTIONAL PSTR Buffer,
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG OptionsSize) PURE;
	...
	(
		THIS_
			IN ULONG Flags,
		IN PCSTR Options,
		IN PVOID Reserved) PURE;
	STDMETHOD(ConnectProcessServer)
	(
		THIS_
			IN PCSTR RemoteOptions,
		OUT PULONG64 Server) PURE;
	...
	(
		...
		IN ULONG Count,
		OUT OPTIONAL PULONG ActualCount) PURE;
	...
	(
		...
		OUT OPTIONAL PULONG ActualDescriptionSize) PURE;
	...
	(
		THIS_
			OUT PULONG Options) PURE;
	STDMETHOD(AddProcessOptions)
	(
		THIS_
			IN ULONG Options) PURE;
	...
	(
		THIS_
			OUT PDEBUG_INPUT_CALLBACKS *
		Callbacks) PURE;
	STDMETHOD(SetInputCallbacks)
	(
		THIS_
			IN PDEBUG_INPUT_CALLBACKS Callbacks) PURE;

	// Output callback interfaces are described separately.
	STDMETHOD(GetOutputCallbacks)
	(
		THIS_
			OUT PDEBUG_OUTPUT_CALLBACKS *
		Callbacks) PURE;
	STDMETHOD(SetOutputCallbacks)
	(
		THIS_
			IN PDEBUG_OUTPUT_CALLBACKS Callbacks) PURE;
	...
	(
		THIS_
			OUT PULONG Columns) PURE;
	STDMETHOD(SetOutputWidth)
	(
		THIS_
			IN ULONG Columns) PURE;
	...
	(
		THIS_
			OUT OPTIONAL PSTR Buffer,
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG PrefixSize) PURE;
	...
	(
		THIS_
			OUT OPTIONAL PSTR Buffer,
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG IdentitySize) PURE;
	...
	(
		THIS_
			OUT PDEBUG_EVENT_CALLBACKS *
		Callbacks) PURE;
	STDMETHOD(SetEventCallbacks)
	(
		THIS_
			IN PDEBUG_EVENT_CALLBACKS Callbacks) PURE;
...
// Special index that returns the name of the last .dmp file that failed
// to laod (whether directly or from inside a .cab file
...
DECLARE_INTERFACE_(IDebugClient2, IUnknown) {
	...
	(
		...
		IN OPTIONAL PCSTR Comment) PURE;
...
DECLARE_INTERFACE_(IDebugClient4, IUnknown) {
	...
	(
		...
		IN ULONG Qualifier,
		IN ULONG FormatFlags,
		IN OPTIONAL PCWSTR Comment) PURE;
...
DECLARE_INTERFACE_(IDebugControl, IUnknown) {
	...
	(
		THIS_
			OUT PULONG Seconds) PURE;
	STDMETHOD(SetInterruptTimeout)
	(
		THIS_
			IN ULONG Seconds) PURE;
	...
	(
		THIS_
			OUT PSTR Buffer,
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG InputSize) PURE;
	...
	(
		THIS_
			OUT OPTIONAL PSTR Buffer,
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG TextSize) PURE;
	...
	(
		THIS_
			OUT PULONG64 Handle) PURE;
	STDMETHOD(SetNotifyEventHandle)
	(
		THIS_
			IN ULONG64 Handle) PURE;
	...
	(
		...
		OUT OPTIONAL /* size_is(TotalLines) */ PULONG64 LineOffsets) PURE;
	...
	(
		...
		IN ULONG FramesSize,
		OUT OPTIONAL PULONG FramesFilled) PURE;
	...
	(
		THIS_
			IN ULONG Start,
		IN ULONG Count,
		OUT /* size_is(Count) */ PULONG Types) PURE;
	...
	(
		...
		OUT OPTIONAL PULONG BuildStringUsed) PURE;
	...
	(
		...
		OUT OPTIONAL PULONG AbbrevNameSize) PURE;
	...
	(
		...
		OUT OPTIONAL PSTR Buffer,
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG MacroSize) PURE;
	...
	(
		...
		OUT OPTIONAL PULONG RemainderIndex) PURE;
	...
	(
		...
		OUT /* size_is(Count) */ PDEBUG_VALUE Out) PURE;
	...
	(
		...
		IN ULONG Start,
		OUT /* size_is(Count) */ PDEBUG_BREAKPOINT_PARAMETERS Params) PURE;
	...
	(
		THIS_
			IN ULONG64 Handle,
		IN PCSTR Function,
		IN OPTIONAL PCSTR Arguments) PURE;
	...
	(
		THIS_
			IN OUT PWINDBG_EXTENSION_APIS32 Api) PURE;
	STDMETHOD(GetWindbgExtensionApis64)
	(
		THIS_
			IN OUT PWINDBG_EXTENSION_APIS64 Api) PURE;
	...
	(
		...
		OUT PULONG ArbitraryExceptions) PURE;
	...
	(
		THIS_
			IN ULONG Start,
		IN ULONG Count,
		OUT /* size_is(Count) */ PDEBUG_SPECIFIC_FILTER_PARAMETERS Params) PURE;
	STDMETHOD(SetSpecificFilterParameters)
	(
		THIS_
			IN ULONG Start,
		IN ULONG Count,
		IN /* size_is(Count) */ PDEBUG_SPECIFIC_FILTER_PARAMETERS Params) PURE;
	...
	(
		...
		OUT OPTIONAL PSTR Buffer,
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG ArgumentSize) PURE;
	STDMETHOD(SetSpecificFilterArgument)
	(
		THIS_
			IN ULONG Index,
		IN PCSTR Argument) PURE;
	...
	(
		...
		IN ULONG Start,
		OUT /* size_is(Count) */ PDEBUG_EXCEPTION_FILTER_PARAMETERS Params) PURE;
	...
	(
		THIS_
			IN ULONG Count,
		IN /* size_is(Count) */ PDEBUG_EXCEPTION_FILTER_PARAMETERS Params) PURE;
	...
	(
		...
		OUT OPTIONAL PSTR Description,
		IN ULONG DescriptionSize,
		OUT OPTIONAL PULONG DescriptionUsed) PURE;
};
...
DECLARE_INTERFACE_(IDebugControl2, IUnknown) {
	...
	(
		...
		OUT OPTIONAL PULONG DstSize) PURE;
	...
	(
		THIS_
			IN PCSTR SrcText,
		IN OPTIONAL PCSTR DstText) PURE;
...
DECLARE_INTERFACE_(IDebugControl3, IUnknown) {
	...
	(
		...
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG DescSize) PURE;
	STDMETHOD(GetCurrentEventIndex)
	(
		THIS_
			OUT PULONG Index) PURE;
...
DECLARE_INTERFACE_(IDebugDataSpaces, IUnknown) {
	...
	(
		...
		OUT PVOID Buffer,
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG BytesRead) PURE;
	...
	(
		...
		IN PVOID Buffer,
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG BytesWritten) PURE;
	...
	(
		THIS_
			IN ULONG Count,
		IN ULONG64 Offset,
		OUT /* size_is(Count) */ PULONG64 Ptrs) PURE;
	STDMETHOD(WritePointersVirtual)
	(
		THIS_
			IN ULONG Count,
		IN ULONG64 Offset,
		IN /* size_is(Count) */ PULONG64 Ptrs) PURE;
	...
	(
		THIS_
			IN ULONG Msr,
		OUT PULONG64 Value) PURE;
	STDMETHOD(WriteMsr)
	(
		THIS_
			IN ULONG Msr,
		IN ULONG64 Value) PURE;
	...
	(
		...
		OUT PVOID Buffer,
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG DataSize) PURE;
...
DECLARE_INTERFACE_(IDebugDataSpaces2, IUnknown) {
	...
	(
		...
		OUT OPTIONAL PULONG Levels) PURE;
	...
	(
		...
		IN PVOID Pattern,
		IN ULONG PatternSize,
		OUT OPTIONAL PULONG Filled) PURE;
	...
	(
		THIS_
			IN ULONG64 Offset,
		OUT PMEMORY_BASIC_INFORMATION64 Info) PURE;
};
...
DECLARE_INTERFACE_(IDebugDataSpaces3, IUnknown) {
	...
	(
		...
		OUT PIMAGE_NT_HEADERS64 Headers) PURE;
	...
	(
		...
		OUT OPTIONAL PVOID Buffer,
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG TotalSize) PURE;
...
DECLARE_INTERFACE_(IDebugEventCallbacks, IUnknown) {
	...
	(
		...
		IN ULONG64 StartOffset) PURE;
	STDMETHOD(ExitThread)
	(
		THIS_
			IN ULONG ExitCode) PURE;
	...
	(
		...
		IN PCSTR ImageName,
		IN ULONG CheckSum,
		IN ULONG TimeDateStamp) PURE;
	STDMETHOD(UnloadModule)
	(
		THIS_
			IN PCSTR ImageBaseName,
		IN ULONG64 BaseOffset) PURE;
...
DECLARE_INTERFACE_(IDebugRegisters, IUnknown) {
	...
	(
		...
		OUT OPTIONAL PULONG NameSize,
		OUT OPTIONAL PDEBUG_REGISTER_DESCRIPTION Desc) PURE;
	...
	(
		...
		IN ULONG Start,
		OUT /* size_is(Count) */ PDEBUG_VALUE Values) PURE;
	STDMETHOD(SetValues)
	(
		THIS_
			IN ULONG Count,
		IN OPTIONAL /* size_is(Count) */ PULONG Indices,
		IN ULONG Start,
		IN /* size_is(Count) */ PDEBUG_VALUE Values) PURE;
...
DECLARE_INTERFACE_(IDebugSymbolGroup, IUnknown) {
	...
	(
		...
		OUT OPTIONAL PSTR Buffer,
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG NameSize) PURE;
	STDMETHOD(GetSymbolParameters)
	(
		THIS_
			IN ULONG Start,
		IN ULONG Count,
		OUT /* size_is(Count) */ PDEBUG_SYMBOL_PARAMETERS Params) PURE;
...
DECLARE_INTERFACE_(IDebugSymbols, IUnknown) {
	...
	(
		...
		IN ULONG NameBufferSize,
		OUT OPTIONAL PULONG NameSize,
		OUT OPTIONAL PULONG64 Displacement) PURE;
	...
	(
		THIS_
			OUT PULONG Loaded,
		OUT PULONG Unloaded) PURE;
	STDMETHOD(GetModuleByIndex)
	(
		THIS_
			IN ULONG Index,
		OUT PULONG64 Base) PURE;
	...
	(
		...
		OUT OPTIONAL PULONG64 Base) PURE;
	...
	(
		...
		OUT OPTIONAL PULONG LoadedImageNameSize) PURE;
	...
	(
		...
		IN ULONG Start,
		OUT /* size_is(Count) */ PDEBUG_MODULE_PARAMETERS Params) PURE;
	...
	(
		THIS_
			IN PCSTR Symbol,
		OUT PULONG TypeId,
		OUT OPTIONAL PULONG64 Module) PURE;
	...
	(
		...
		IN ULONG ScopeContextSize) PURE;
	...
	(
		...
		OUT PDEBUG_SYMBOL_GROUP * Symbols) PURE;

	// Create a new symbol group.
	STDMETHOD(CreateSymbolGroup)
	(
		THIS_
			OUT PDEBUG_SYMBOL_GROUP *
		Group) PURE;
	...
	(
		...
		OUT OPTIONAL PULONG64 Offset) PURE;
	...
	(
		THIS_
			OUT OPTIONAL PSTR Buffer,
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG PathSize) PURE;
	...
	(
		...
		OUT OPTIONAL PSTR Buffer,
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG ElementSize) PURE;
	...
	(
		...
		OUT OPTIONAL PSTR Buffer,
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG FoundSize) PURE;
	...
	(
		...
		OUT OPTIONAL PULONG FileLines) PURE;
};
...
DECLARE_INTERFACE_(IDebugSymbols2, IUnknown) {
	...
	(
		...
		OUT OPTIONAL PVOID Buffer,
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG VerInfoSize) PURE;
...
DECLARE_INTERFACE_(IDebugSystemObjects, IUnknown) {
	...
	(
		THIS_
			OUT PULONG Total,
		OUT PULONG LargestProcess) PURE;
	...
	(
		...
		IN ULONG Count,
		OUT OPTIONAL /* size_is(Count) */ PULONG Ids,
		OUT OPTIONAL /* size_is(Count) */ PULONG SysIds) PURE;
	...
	(
		THIS_
			OUT OPTIONAL PSTR Buffer,
		IN ULONG BufferSize,
		OUT OPTIONAL PULONG ExeSize) PURE;
};
...
DECLARE_INTERFACE_(IDebugSystemObjects3, IUnknown) {
	...
	(
		THIS_
			IN ULONG Start,
		IN ULONG Count,
		OUT /* size_is(Count) */ PULONG Ids) PURE;
	...
	(
		...
		OUT PULONG LargestSystemProcesses) PURE;
...
typedef HRESULT(CALLBACK* PDEBUG_EXTENSION_INITIALIZE)(OUT PULONG Version, OUT PULONG Flags);
...
typedef HRESULT(CALLBACK* PDEBUG_EXTENSION_CALL)(IN PDEBUG_CLIENT Client, IN OPTIONAL PCSTR Args);
