...
typedef enum tagIFILTER_INIT { IFILTER_INIT_CANON_PARAGRAPHS = 1,
...
typedef enum tagIFILTER_FLAGS { IFILTER_FLAGS_OLE_PROPERTIES = 1
} IFILTER_FLAGS;
...
typedef enum tagCHUNKSTATE { CHUNK_TEXT = 0x1,
							 CHUNK_VALUE = 0x2
} CHUNKSTATE;
...
typedef enum tagCHUNK_BREAKTYPE { CHUNK_NO_BREAK = 0,
								  CHUNK_EOW = 1,
								  CHUNK_EOS = 2,
								  CHUNK_EOP = 3,
								  CHUNK_EOC = 4
