...
#endif
typedef enum tagBIND_FLAGS { BIND_MAYBOTHERUSER = 1,
...
typedef enum tagMKSYS { MKSYS_NONE = 0,
...
#endif //_MAC
typedef enum tagSTGTY { STGTY_STORAGE = 1,
						STGTY_STREAM = 2,
						STGTY_LOCKBYTES = 3,
						STGTY_PROPERTY = 4
} STGTY;

typedef enum tagSTREAM_SEEK { STREAM_SEEK_SET = 0,
							  STREAM_SEEK_CUR = 1,
							  STREAM_SEEK_END = 2
} STREAM_SEEK;

typedef enum tagLOCKTYPE { LOCK_WRITE = 1,
						   LOCK_EXCLUSIVE = 2,
						   LOCK_ONLYONCE = 4
} LOCKTYPE;
...
typedef enum tagADVF { ADVF_NODATA = 1,
					   ADVF_PRIMEFIRST = 2,
					   ADVF_ONLYONCE = 4,
					   ADVF_DATAONSTOP = 64,
...
typedef enum tagDATADIR { DATADIR_GET = 1,
						  DATADIR_SET = 2
} DATADIR;
...
typedef enum tagCALLTYPE { CALLTYPE_TOPLEVEL = 1,
						   CALLTYPE_NESTED = 2,
						   CALLTYPE_ASYNC = 3,
...
typedef enum tagSERVERCALL { SERVERCALL_ISHANDLED = 0,
							 SERVERCALL_REJECTED = 1,
							 SERVERCALL_RETRYLATER = 2
} SERVERCALL;

typedef enum tagPENDINGTYPE { PENDINGTYPE_TOPLEVEL = 1,
							  PENDINGTYPE_NESTED = 2
} PENDINGTYPE;

typedef enum tagPENDINGMSG { PENDINGMSG_CANCELCALL = 0,
...
typedef enum tagEOLE_AUTHENTICATION_CAPABILITIES { EOAC_NONE = 0,
...
enum __MIDL___MIDL_itf_objidl_0055_0001 { COMBND_RPCTIMEOUT = 0x1,
										  COMBND_SERVER_LOCALITY = 0x2
};

enum __MIDL___MIDL_itf_objidl_0055_0002 { SERVER_LOCALITY_PROCESS_LOCAL = 0,
...
typedef enum tagDCOM_CALL_STATE { DCOM_NONE = 0,
...
#endif
typedef enum tagApplicationType { ServerApplication = 0,
								  LibraryApplication = ServerApplication + 1
} ApplicationType;

typedef enum tagShutdownType { IdleShutdown = 0,
...
typedef enum _APTTYPE { APTTYPE_CURRENT = -1,
						APTTYPE_STA = 0,
						APTTYPE_MTA = 1,
						APTTYPE_NA = 2,
						APTTYPE_MAINSTA = 3
...
typedef enum _THDTYPE { THDTYPE_BLOCKMESSAGES = 0,
