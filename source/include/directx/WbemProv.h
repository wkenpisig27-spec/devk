...
typedef /* [v1_enum] */
	enum tag_WBEM_PROVIDER_REQUIREMENTS_TYPE { WBEM_REQUIREMENTS_START_POSTFILTER = 0,
...
typedef enum tag_WBEM_EXTRA_RETURN_CODES { WBEM_S_INITIALIZED = 0,
...
typedef enum tag_WBEM_PROVIDER_FLAGS { WBEM_FLAG_OWNER_UPDATE = 0x10000
} WBEM_PROVIDER_FLAGS;
...
typedef /* [v1_enum] */
	enum tag_WBEM_BATCH_TYPE { WBEM_FLAG_BATCH_IF_NEEDED = 0,
