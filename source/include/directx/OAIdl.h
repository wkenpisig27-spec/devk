...
typedef /* [v1_enum] */
	enum tagSF_TYPE { SF_ERROR = VT_ERROR,
					  SF_I1 = VT_I1,
					  SF_I2 = VT_I2,
					  SF_I4 = VT_I4,
					  SF_I8 = VT_I8,
...
typedef enum tagTYPEFLAGS { TYPEFLAG_FAPPOBJECT = 0x1,
...
typedef enum tagFUNCFLAGS { FUNCFLAG_FRESTRICTED = 0x1,
...
typedef enum tagVARFLAGS { VARFLAG_FREADONLY = 0x1,
						   VARFLAG_FSOURCE = 0x2,
...
typedef enum tagCHANGEKIND { CHANGEKIND_ADDMEMBER = 0,
