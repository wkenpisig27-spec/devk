...
typedef enum tagWORDREP_BREAK_TYPE { WORDREP_BREAK_EOW = 0,
									 WORDREP_BREAK_EOS = 1,
									 WORDREP_BREAK_EOP = 2,
									 WORDREP_BREAK_EOC = 3
} WORDREP_BREAK_TYPE;
...
#define CLSID_CISimpleCommandCreator                                                  \
	{                                                                                 \
		0xc7b6c04a, 0xcbb5, 0x11d0, { 0xbb, 0x4c, 0x0, 0xc0, 0x4f, 0xc2, 0xf4, 0x10 } \
	}
