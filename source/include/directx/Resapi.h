...
typedef VOID(_stdcall* PLOG_EVENT_ROUTINE)(
	IN RESOURCE_HANDLE ResourceHandle,
...
ResUtilGetCoreClusterResources(
	IN HCLUSTER hCluster, OUT HRESOURCE* phClusterNameResource, OUT HRESOURCE* phClusterIPAddressResource, OUT HRESOURCE* phClusterQuorumResource);

DWORD
WINAPI
ResUtilGetResourceName(
	IN HRESOURCE hResource, OUT WCHAR* pszResourceName, IN OUT DWORD* pcchResourceName);
