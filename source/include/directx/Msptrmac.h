...
class CAudioCaptureTerminal : public IDispatchImpl<ITBasicAudioTerminal, &IID_ITBasicAudioTerminal, &LIBID_TAPI3Lib>,
...
public:
	STDMETHOD(get_Balance)
	(OUT long* pVal);
	STDMETHOD(put_Balance)
	(IN long newVal);
