...
typedef enum _MMC_PROPERTY_ACTION { MMC_PROPACT_DELETING = 1,
...
typedef /* [helpstring][v1_enum] */
	enum DocumentMode { DocumentMode_Author = 0,
...
typedef /* [helpstring][v1_enum] */
	enum ListViewMode { ListMode_Small_Icons = 0,
...
typedef /* [helpstring][v1_enum] */
	enum ViewOptions { ViewOption_Default = 0,
...
typedef /* [helpstring][v1_enum] */
	enum ExportListOptions { ExportListOptions_Default = 0,
...
typedef enum ColumnSortOrder { SortOrder_Ascending = 0,
...
/* interface __MIDL_itf_mmcobj_0138 */
/* [local] */
