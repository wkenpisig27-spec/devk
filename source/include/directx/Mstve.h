...
typedef enum NENH_Mode { NENH_New = 0,
...
typedef enum NPKG_Mode { NPKG_Starting = 0,
...
typedef enum NTRK_Mode { NTRK_New = 0,
...
typedef enum NFLE_Mode { NFLE_Received = 0,
						 NFLE_Expired = NFLE_Received + 1
} NFLE_Mode;

typedef enum NTUN_Mode { NTUN_New = 0,
...
typedef enum NWHAT_Mode { NWHAT_Announcement = 0,
...
typedef enum NENH_grfDiff { NENH_grfNone = 0,
...
typedef enum NVAR_grfDiff { NVAR_grfNone = 0,
...
typedef enum NTRK_grfDiff { NTRK_grfNone = 0,
							NTRK_grfURL = 0x1,
							NTRK_grfName = 0x2,
							NTRK_grfScript = 0x4,
							NTRK_grfDate = 0x8,
...
typedef enum NFLT_grfHaltFlags { NFLT_grfNone = 0,
