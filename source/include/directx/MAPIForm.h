...
#define MAPI_IPERSISTMESSAGE_METHODS(IPURE)       \
	MAPIMETHOD(GetClassID)                        \
	(THIS_ LPCLSID lpClassID) IPURE;              \
	MAPIMETHOD(IsDirty)                           \
	(THIS) IPURE;                                 \
	MAPIMETHOD(InitNew)                           \
	(THIS_ /*in*/ LPMAPIMESSAGESITE pMessageSite, \
	...
	MAPIMETHOD(Save)                              \
	(THIS_ /*in*/ LPMESSAGE pMessage,             \
	 /*in*/ ULONG fSameAsLoad) IPURE;             \
	MAPIMETHOD(SaveCompleted)                     \
	(THIS_ /*in*/ LPMESSAGE pMessage) IPURE;      \
	MAPIMETHOD(HandsOffMessage)                   \
	(THIS) IPURE;
...
#define MAPI_IMAPIMESSAGESITE_METHODS(IPURE)               \
	MAPIMETHOD(GetSession)                                 \
	(THIS_ /*out*/ LPMAPISESSION FAR * ppSession) IPURE;   \
	MAPIMETHOD(GetStore)                                   \
	(THIS_ /*out*/ LPMDB FAR * ppStore) IPURE;             \
	MAPIMETHOD(GetFolder)                                  \
	(THIS_ /*out*/ LPMAPIFOLDER FAR * ppFolder) IPURE;     \
	MAPIMETHOD(GetMessage)                                 \
	(THIS_ /*out*/ LPMESSAGE FAR * ppmsg) IPURE;           \
	MAPIMETHOD(GetFormManager)                             \
	(THIS_ /*out*/ LPMAPIFORMMGR FAR * ppFormMgr) IPURE;   \
	MAPIMETHOD(NewMessage)                                 \
	(THIS_ /*in*/ ULONG fComposeInFolder,                  \
	...
	MAPIMETHOD(CopyMessage)                                \
	(THIS_ /*in*/ LPMAPIFOLDER pFolderDestination) IPURE;  \
	MAPIMETHOD(MoveMessage)                                \
	(THIS_ /*in*/ LPMAPIFOLDER pFolderDestination,         \
	 /*in*/ LPMAPIVIEWCONTEXT pViewContext,                \
	 /*in*/ LPCRECT prcPosRect) IPURE;                     \
	MAPIMETHOD(DeleteMessage)                              \
	(THIS_ /*in*/ LPMAPIVIEWCONTEXT pViewContext,          \
	 /*in*/ LPCRECT prcPosRect) IPURE;                     \
	MAPIMETHOD(SaveMessage)                                \
	(THIS) IPURE;                                          \
	MAPIMETHOD(SubmitMessage)                              \
	(THIS_ /*in*/ ULONG ulFlags) IPURE;                    \
	MAPIMETHOD(GetSiteStatus)                              \
	(THIS_ /*out*/ LPULONG lpulStatus) IPURE;
...
#define MAPI_IMAPIFORM_METHODS(IPURE)                            \
	MAPIMETHOD(SetViewContext)                                   \
	(THIS_ /*in*/ LPMAPIVIEWCONTEXT pViewContext) IPURE;         \
	MAPIMETHOD(GetViewContext)                                   \
	(THIS_ /*out*/ LPMAPIVIEWCONTEXT FAR * ppViewContext) IPURE; \
	MAPIMETHOD(ShutdownForm)                                     \
	(THIS_ /*in*/ ULONG ulSaveOptions) IPURE;                    \
	MAPIMETHOD(DoVerb)                                           \
	(THIS_ /*in*/ LONG iVerb,                                    \
	...
	MAPIMETHOD(Advise)                                           \
	(THIS_ /*in*/ LPMAPIVIEWADVISESINK pAdvise,                  \
	 /*out*/ ULONG FAR * pdwStatus) IPURE;                       \
	MAPIMETHOD(Unadvise)                                         \
	(THIS_ /*in*/ ULONG ulConnection) IPURE;
...
#define MAPI_IMAPIVIEWCONTEXT_METHODS(IPURE)                  \
	MAPIMETHOD(SetAdviseSink)                                 \
	(THIS_ /*in*/ LPMAPIFORMADVISESINK pmvns) IPURE;          \
	MAPIMETHOD(ActivateNext)                                  \
	(THIS_ /*in*/ ULONG ulDir,                                \
	 /*in*/ LPCRECT prcPosRect) IPURE;                        \
	MAPIMETHOD(GetPrintSetup)                                 \
	(THIS_ /*in*/ ULONG ulFlags,                              \
	 /*out*/ LPFORMPRINTSETUP FAR * lppFormPrintSetup) IPURE; \
	MAPIMETHOD(GetSaveStream)                                 \
	(THIS_ /*out*/ ULONG FAR * pulFlags,                      \
	 /*out*/ ULONG FAR * pulFormat,                           \
	 /*out*/ LPSTREAM FAR * ppstm) IPURE;                     \
	MAPIMETHOD(GetViewStatus)                                 \
	(THIS_ /*out*/ LPULONG lpulStatus) IPURE;
...
#define MAPI_IMAPIFORMADVISESINK_METHODS(IPURE) \
	STDMETHOD(OnChange)                         \
	(THIS_ ULONG ulDir) IPURE;                  \
	STDMETHOD(OnActivateNext)                   \
	(THIS_ /*in*/ LPCSTR lpszMessageClass,      \
	 /*in*/ ULONG ulMessageStatus,              \
...
#define MAPI_IMAPIVIEWADVISESINK_METHODS(IPURE) \
	MAPIMETHOD(OnShutdown)                      \
	(THIS) IPURE;                               \
	MAPIMETHOD(OnNewMessage)                    \
	(THIS) IPURE;                               \
	MAPIMETHOD(OnPrint)                         \
	(THIS_ /*in*/ ULONG dwPageNumber,           \
	 /*in*/ HRESULT hrStatus) IPURE;            \
	MAPIMETHOD(OnSubmitted)                     \
	(THIS) IPURE;                               \
	MAPIMETHOD(OnSaved)                         \
	(THIS) IPURE;
...
#define MAPI_IMAPIFORMINFO_METHODS(IPURE)                      \
	MAPIMETHOD(CalcFormPropSet)                                \
	(THIS_ /*in*/ ULONG ulFlags,                               \
	 /*out*/ LPMAPIFORMPROPARRAY FAR * ppFormPropArray) IPURE; \
	MAPIMETHOD(CalcVerbSet)                                    \
	(THIS_ /*in*/ ULONG ulFlags,                               \
	 /*out*/ LPMAPIVERBARRAY FAR * ppMAPIVerbArray) IPURE;     \
	MAPIMETHOD(MakeIconFromBinary)                             \
	(THIS_ /*in*/ ULONG nPropID,                               \
	 /*out*/ HICON FAR * phicon) IPURE;                        \
	MAPIMETHOD(SaveForm)                                       \
	(THIS_ /*in*/ LPCTSTR szFileName) IPURE;                   \
	MAPIMETHOD(OpenFormContainer)                              \
	(THIS_ /*out*/ LPMAPIFORMCONTAINER FAR * ppformcontainer) IPURE;
...
#define MAPI_IMAPIFORMMGR_METHODS(IPURE)                       \
	...
	MAPIMETHOD(SelectFormContainer)                            \
	(THIS_ /*in*/ ULONG ulUIParam,                             \
	 /*in*/ ULONG ulFlags,                                     \
	 /*out*/ LPMAPIFORMCONTAINER FAR * lppfcnt) IPURE;         \
	MAPIMETHOD(OpenFormContainer)                              \
	(THIS_ /*in*/ HFRMREG hfrmreg,                             \
	 /*in*/ LPUNKNOWN lpunk,                                   \
	 /*out*/ LPMAPIFORMCONTAINER FAR * lppfcnt) IPURE;         \
	...
	MAPIMETHOD(IsInConflict)                                   \
	(THIS_ /*in*/ ULONG ulMessageFlags,                        \
	 /*in*/ ULONG ulMessageStatus,                             \
...
#define MAPI_IMAPIFORMCONTAINER_METHODS(IPURE)                 \
	MAPIMETHOD(InstallForm)                                    \
	(THIS_ /*in*/ ULONG ulUIParam,                             \
	 /*in*/ ULONG ulFlags,                                     \
	 /*in*/ LPCTSTR szCfgPathName) IPURE;                      \
	MAPIMETHOD(RemoveForm)                                     \
	(THIS_ /*in*/ LPCSTR szMessageClass) IPURE;                \
	MAPIMETHOD(ResolveMessageClass)                            \
	(THIS_ /*in*/ LPCSTR szMessageClass,                       \
	 /*in*/ ULONG ulFlags,                                     \
	 /*out*/ LPMAPIFORMINFO FAR * pforminfo) IPURE;            \
	MAPIMETHOD(ResolveMultipleMessageClasses)                  \
	(THIS_ /*in*/ LPSMESSAGECLASSARRAY pMsgClassArray,         \
	 /*in*/ ULONG ulFlags,                                     \
	 /*out*/ LPSMAPIFORMINFOARRAY FAR * ppfrminfoarray) IPURE; \
	MAPIMETHOD(CalcFormPropSet)                                \
	(THIS_ /*in*/ ULONG ulFlags,                               \
	 /*out*/ LPMAPIFORMPROPARRAY FAR * ppResults) IPURE;       \
	MAPIMETHOD(GetDisplay)                                     \
	(THIS_ /*in*/ ULONG ulFlags,                               \
...
#define MAPI_IMAPIFORMFACTORY_METHODS(IPURE)              \
	MAPIMETHOD(CreateClassFactory)                        \
	(THIS_ /*in*/ REFCLSID clsidForm,                     \
	 /*in*/ ULONG ulFlags,                                \
	 /*out*/ LPCLASSFACTORY FAR * lppClassFactory) IPURE; \
	MAPIMETHOD(LockServer)                                \
	(THIS_ /*in*/ ULONG ulFlags,                          \
