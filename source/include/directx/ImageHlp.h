...
typedef BOOL(__stdcall* PIMAGEHLP_STATUS_ROUTINE)(
...
typedef BOOL(__stdcall* PIMAGEHLP_STATUS_ROUTINE32)(
	IMAGEHLP_STATUS_REASON Reason,
	PSTR ImageName,
	PSTR DllName,
	ULONG Va,
...
typedef BOOL(__stdcall* PIMAGEHLP_STATUS_ROUTINE64)(
	IMAGEHLP_STATUS_REASON Reason,
	PSTR ImageName,
	PSTR DllName,
	ULONG64 Va,
...
BOOL
	...
	MiniDumpWriteDump(
		...
		IN CONST PMINIDUMP_EXCEPTION_INFORMATION ExceptionParam, OPTIONAL IN CONST PMINIDUMP_USER_STREAM_INFORMATION UserStreamParam, OPTIONAL IN CONST PMINIDUMP_CALLBACK_INFORMATION CallbackParam OPTIONAL);
...
BOOL
	...
	MiniDumpReadDumpStream(
		...
		OUT PMINIDUMP_DIRECTORY* Dir, OPTIONAL OUT PVOID* StreamPointer, OPTIONAL OUT ULONG* StreamSize OPTIONAL);
