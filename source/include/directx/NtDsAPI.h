...
#define DS_BEHAVIOR_WIN_DOT_NET_WITH_MIXED_DOMAINS 1
#define DS_BEHAVIOR_WIN_DOT_NET 2
...
#define FRSCONN_GET_PRIORITY(_options_) \
	(((((_options_)&FRSCONN_PRIORITY_MASK) >> 28) != 0) ? (((_options_)&FRSCONN_PRIORITY_MASK) >> 28) : FRSCONN_MAX_PRIORITY)
