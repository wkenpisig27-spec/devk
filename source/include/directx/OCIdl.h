...
typedef /* [v1_enum] */
	enum tagREADYSTATE { READYSTATE_UNINITIALIZED = 0,
...
typedef enum tagGUIDKIND { GUIDKIND_DEFAULT_SOURCE_DISP_IID = 1
} GUIDKIND;
...
typedef enum tagCTRLINFO { CTRLINFO_EATS_RETURN = 1,
...
typedef enum tagXFORMCOORDS { XFORMCOORDS_POSITION = 0x1,
...
typedef enum tagPROPPAGESTATUS { PROPPAGESTATUS_DIRTY = 0x1,
...
typedef enum tagPictureAttributes { PICTURE_SCALABLE = 0x1,
...
typedef /* [v1_enum] */
	enum tagOLEDCFLAGS { OLEDC_NODRAW = 0x1,
...
typedef /* [v1_enum] */
	enum tagVIEWSTATUS { VIEWSTATUS_OPAQUE = 1,
...
typedef /* [v1_enum] */
	enum tagHITRESULT { HITRESULT_OUTSIDE = 0,
...
typedef /* [v1_enum] */
	enum tagDVASPECT2 { DVASPECT_OPAQUE = 16,
...
typedef /* [v1_enum] */
	enum tagExtentMode { DVEXTENT_CONTENT = 0,
...
typedef struct IViewObjectExVtbl {
	...
	/* [local] */ HRESULT(STDMETHODCALLTYPE* Draw)(
		...
		/* [in] */ BOOL(STDMETHODCALLTYPE* pfnContinue)(ULONG_PTR dwContinue),
...
typedef /* [v1_enum] */
	enum tagPOINTERINACTIVE { POINTERINACTIVE_ACTIVATEONENTRY = 1,
...
typedef /* [v1_enum] */
	enum tagPROPBAG2_TYPE { PROPBAG2_TYPE_UNDEFINED = 0,
...
typedef /* [v1_enum] */
	enum tagQACONTAINERFLAGS { QACONTAINER_SHOWHATCHING = 0x1,
