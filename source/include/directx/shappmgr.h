...
typedef enum _tagAppInfoFlags { AIM_DISPLAYNAME = 0x1,
								AIM_VERSION = 0x2,
								AIM_PUBLISHER = 0x4,
								AIM_PRODUCTID = 0x8,
...
typedef enum _tagAppActionFlags { APPACTION_INSTALL = 0x1,
...
typedef enum _tagPublishedAppInfoFlags { PAI_SOURCE = 0x1,
...
/* interface __MIDL_itf_shappmgr_0261 */
/* [local] */
