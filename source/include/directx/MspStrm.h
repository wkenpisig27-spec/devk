...
class ATL_NO_VTABLE CPTEventSink : public CComObjectRootEx<CComMultiThreadModel>,
...
class ATL_NO_VTABLE CMSPStream : public CComObjectRootEx<CComMultiThreadModelNoCS>,
...
public:
	...
	virtual HRESULT GetState(
		OUT DWORD* pdwStatus) { return E_NOTIMPL; }
