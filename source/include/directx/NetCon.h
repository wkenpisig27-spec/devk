...
typedef enum tagNETCON_CHARACTERISTIC_FLAGS { NCCF_NONE = 0,
											  NCCF_ALL_USERS = 0x1,
...
typedef enum tagNETCON_STATUS { NCS_DISCONNECTED = 0,
...
typedef enum tagNETCON_TYPE { NCT_DIRECT_CONNECT = 0,
...
typedef enum tagNETCON_MEDIATYPE { NCM_NONE = 0,
...
STDAPI_(BOOL)
NcIsValidConnectionName(PCWSTR pszwName);
...
typedef enum tagNETCONMGR_ENUM_FLAGS { NCME_DEFAULT = 0
...
typedef enum tagNETCONUI_CONNECT_FLAGS { NCUC_DEFAULT = 0,
										 NCUC_NO_UI = 0x1
...
typedef enum tagNETCON_CHOOSEFLAGS { NCCHF_CONNECT = 0x1,
									 NCCHF_CAPTION = 0x2,
...
typedef enum tagNETCON_CHOOSETYPE { NCCHT_DIRECT_CONNECT = 0x1,
									NCCHT_LAN = 0x2,
									NCCHT_PHONE = 0x4,
									NCCHT_TUNNEL = 0x8,
									NCCHT_ISDN = 0x10,
...
typedef enum tagSHARINGCONNECTIONTYPE { ICSSHARINGTYPE_PUBLIC = 0,
...
typedef enum tagSHARINGCONNECTION_ENUM_FLAGS { ICSSC_DEFAULT = 0,
											   ICSSC_ENABLED = ICSSC_DEFAULT + 1
} SHARINGCONNECTION_ENUM_FLAGS;

typedef enum tagICS_TARGETTYPE { ICSTT_NAME = 0,
