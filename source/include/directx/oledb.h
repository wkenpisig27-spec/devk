...
enum DBKINDENUM { DBKIND_GUID_NAME = 0,
...
enum DBTYPEENUM { DBTYPE_EMPTY = 0,
				  DBTYPE_NULL = 1,
				  DBTYPE_I2 = 2,
				  DBTYPE_I4 = 3,
				  DBTYPE_R4 = 4,
...
enum DBTYPEENUM20 { DBTYPE_FILETIME = 64,
...
enum DBPARTENUM { DBPART_INVALID = 0,
				  DBPART_VALUE = 0x1,
				  DBPART_LENGTH = 0x2,
				  DBPART_STATUS = 0x4
};
...
enum DBPARAMIOENUM { DBPARAMIO_NOTPARAM = 0,
					 DBPARAMIO_INPUT = 0x1,
...
enum DBMEMOWNERENUM { DBMEMOWNER_CLIENTOWNED = 0,
...
enum DBSTATUSENUM { DBSTATUS_S_OK = 0,
...
enum DBSTATUSENUM20 { MDSTATUS_S_CELLEMPTY = 14,
...
enum DBSTATUSENUM21 { DBSTATUS_E_DOESNOTEXIST = 16,
...
enum DBBINDURLSTATUSENUM { DBBINDURLSTATUS_S_OK = 0L,
...
enum DBSTATUSENUM25 { DBSTATUS_E_CANCELED = 27,
...
enum DBROWSTATUSENUM { DBROWSTATUS_S_OK = 0,
...
enum DBROWSTATUSENUM20 { DBROWSTATUS_S_NOCHANGE = 20
};
#endif // OLEDBVER >= 0x0200
//@@@- V2.0
//@@@+ V2.6
...
enum DBSTATUSENUM26 { DBSTATUS_S_ROWSETCOLUMN = 29
};
...
enum DBCOLUMNFLAGSENUM { DBCOLUMNFLAGS_ISBOOKMARK = 0x1,
...
enum DBCOLUMNFLAGSENUM20 { DBCOLUMNFLAGS_SCALEISNEGATIVE = 0x4000,
...
enum DBCOLUMNFLAGSDEPRECATED { DBCOLUMNFLAGS_KEYCOLUMN = 0x8000
};
#endif // OLEDBVER >= 0x0200
//@@@- V2.0
#endif // deprecated
...
enum DBCOLUMNFLAGSENUM21 { DBCOLUMNFLAGS_ISROWURL = 0x10000,
...
enum DBCOLUMNFLAGSENUM26 { DBCOLUMNFLAGS_ISSTREAM = 0x80000,
						   DBCOLUMNFLAGS_ISROWSET = 0x100000,
						   DBCOLUMNFLAGS_ISROW = 0x200000,
						   DBCOLUMNFLAGS_ROWSPECIFICCOLUMN = 0x400000
};

enum DBTABLESTATISTICSTYPE26 { DBSTAT_HISTOGRAM = 0x1,
...
typedef enum tagDBBOOKMARK { DBBMK_INVALID = 0,
...
#ifdef __cplusplus
inline BOOL IsEqualGUIDBase(const GUID& rguid1, const GUID& rguid2) { return !memcmp(&(rguid1.Data2), &(rguid2.Data2), sizeof(GUID) - sizeof(rguid1.Data1)); }
#else // !__cplusplus
...
#define DBCIDGUID                                                                       \
	{                                                                                   \
		0x0C733A81L, 0x2A1C, 0x11CE, { 0xAD, 0xE5, 0x00, 0xAA, 0x00, 0x44, 0x77, 0x3D } \
	}
#define DB_NULLGUID                                                                     \
	{                                                                                   \
...
//@@@+ V2.1
#if (OLEDBVER >= 0x0210)
#define DBGUID_ROWURL                                                                   \
	{                                                                                   \
		0x0C733AB6L, 0x2A1C, 0x11CE, { 0xAD, 0xE5, 0x00, 0xAA, 0x00, 0x44, 0x77, 0x3D } \
	}
#define DBGUID_ROWDEFAULTSTREAM                                                         \
	{                                                                                   \
		0x0C733AB7L, 0x2A1C, 0x11CE, { 0xAD, 0xE5, 0x00, 0xAA, 0x00, 0x44, 0x77, 0x3D } \
	}
...
enum DBPROPENUM { DBPROP_ABORTPRESERVE = 0x2L,
...
enum DBPROPENUM15 { DBPROP_FILTERCOMPAREOPS = 0xd1L,
...
enum DBPROPENUM20 { DBPROP_IMultipleResults = 0xd9L,
...
enum DBPROPENUM21 { DBPROP_TRUSTEE_USERNAME = 0xf1L,
...
enum DBPROPENUM25 { DBPROP_COL_SEED = 0x11aL,
...
enum DBPROPENUM26 { DBPROP_OUTPUTSTREAM = 0x11eL,
...
enum DBPROPENUMDEPRECATED { DBPROP_IRowsetExactScroll = 0x9aL,
...
enum DBPARAMFLAGSENUM { DBPARAMFLAGS_ISINPUT = 0x1,
...
enum DBPROPFLAGSENUM { DBPROPFLAGS_NOTSUPPORTED = 0,
...
enum DBPROPFLAGSENUM26 { DBPROPFLAGS_STREAM = 0x8000
};
#endif // OLEDBVER >= 0x0260
//@@@- V2.6
...
enum DBPROPOPTIONSENUM { DBPROPOPTIONS_REQUIRED = 0,
...
enum DBPROPSTATUSENUM21 { DBPROPSTATUS_NOTAVAILABLE = 9
};
#endif // OLEDBVER >= 0x0210
//@@@- V2.1
...
enum DBINDEX_COL_ORDERENUM { DBINDEX_COL_ORDER_ASC = 0,
...
enum DBCOLUMNDESCFLAGSENUM { DBCOLUMNDESCFLAGS_TYPENAME = 0x1,
...
enum DBEVENTPHASEENUM { DBEVENTPHASE_OKTODO = 0,
...
enum DBREASONENUM { DBREASON_ROWSET_FETCHPOSITIONCHANGE = 0,
...
enum DBREASONENUM15 { DBREASON_ROWPOSITION_CHANGED = DBREASON_ROWSET_CHANGED + 1,
...
enum DBCOMPAREOPSENUM { DBCOMPAREOPS_LT = 0,
						DBCOMPAREOPS_LE = 1,
						DBCOMPAREOPS_EQ = 2,
						DBCOMPAREOPS_GE = 3,
						DBCOMPAREOPS_GT = 4,
...
enum DBCOMPAREOPSENUM20 { DBCOMPAREOPS_NOTBEGINSWITH = 9,
...
enum DBASYNCHPHASEENUM { DBASYNCHPHASE_INITIALIZATION = 0,
...
enum DBSORTENUM { DBSORT_ASCENDING = 0,
...
enum DBCOMMANDPERSISTFLAGENUM21 { DBCOMMANDPERSISTFLAG_DEFAULT = 0,
								  DBCOMMANDPERSISTFLAG_PERSISTVIEW = 0x2,
								  DBCOMMANDPERSISTFLAG_PERSISTPROCEDURE = 0x4
};
typedef DWORD DBCONSTRAINTTYPE;

enum DBCONSTRAINTTYPEENUM { DBCONSTRAINTTYPE_UNIQUE = 0,
...
enum DBUPDELRULEENUM { DBUPDELRULE_NOACTION = 0,
...
enum DBMATCHTYPEENUM { DBMATCHTYPE_FULL = 0,
					   DBMATCHTYPE_NONE = 0x1,
					   DBMATCHTYPE_PARTIAL = 0x2
};
typedef DWORD DBDEFERRABILITY;

enum DBDEFERRABILITYENUM { DBDEFERRABILITY_DEFERRED = 0x1,
...
enum DBACCESSORFLAGSENUM { DBACCESSOR_INVALID = 0,
...
enum DBBINDSTATUSENUM { DBBINDSTATUS_OK = 0,
...
enum DBCOMPAREENUM { DBCOMPARE_LT = 0,
...
enum DBPENDINGSTATUSENUM { DBPENDINGSTATUS_NEW = 0x1,
...
enum DBSEEKENUM { DBSEEK_INVALID = 0,
				  DBSEEK_FIRSTEQ = 0x1,
				  DBSEEK_LASTEQ = 0x2,
				  DBSEEK_AFTEREQ = 0x4,
				  DBSEEK_AFTER = 0x8,
...
enum DBRANGEENUM { DBRANGE_INCLUSIVESTART = 0,
...
enum DBRANGEENUM20 { DBRANGE_MATCH_N_SHIFT = 0x18,
...
enum DBRESULTFLAGENUM { DBRESULTFLAG_DEFAULT = 0,
...
enum DBCONVERTFLAGSENUM { DBCONVERTFLAGS_COLUMN = 0,
						  DBCONVERTFLAGS_PARAMETER = 0x1
};
//@@@+ V2.0
#if (OLEDBVER >= 0x0200)

enum DBCONVERTFLAGSENUM20 { DBCONVERTFLAGS_ISLONG = 0x2,
...
enum DBSOURCETYPEENUM { DBSOURCETYPE_DATASOURCE = 1,
						DBSOURCETYPE_ENUMERATOR = 2
};
//@@@+ V2.0
#if (OLEDBVER >= 0x0200)

enum DBSOURCETYPEENUM20 { DBSOURCETYPE_DATASOURCE_TDP = 1,
...
enum DBSOURCETYPEENUM25 { DBSOURCETYPE_BINDER = 4
};
#endif // OLEDBVER >= 0x0250
//@@@- V2.5
...
enum DBLITERALENUM { DBLITERAL_INVALID = 0,
...
enum DBLITERALENUM20 { DBLITERAL_CUBE_NAME = 21,
...
enum ACCESS_MASKENUM { PERM_EXCLUSIVE = 0x200L,
...
enum DBCOPYFLAGSENUM { DBCOPY_ASYNC = 0x100,
...
enum DBMOVEFLAGSENUM { DBMOVE_REPLACE_EXISTING = 0x1,
					   DBMOVE_ASYNC = 0x100,
...
enum DBDELETEFLAGSENUM { DBDELETE_ASYNC = 0x100,
