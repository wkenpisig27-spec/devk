...
typedef DWORD(APIENTRY* LPDHCP_CONTROL)(
...
typedef DWORD(APIENTRY* LPDHCP_NEWPKT)(
...
typedef DWORD(APIENTRY* LPDHCP_DROP_SEND)(
	IN OUT LPBYTE* Packet,
	IN OUT DWORD* PacketSize,
...
typedef DWORD(APIENTRY* LPDHCP_PROB)(
	IN LPBYTE Packet,
	IN DWORD PacketSize,
	IN DWORD ControlCode,
	IN DWORD IpAddress,
...
typedef DWORD(APIENTRY* LPDHCP_GIVE_ADDRESS)(
	IN LPBYTE Packet,
	IN DWORD PacketSize,
	IN DWORD ControlCode,
	IN DWORD IpAddress,
...
typedef DWORD(APIENTRY* LPDHCP_HANDLE_OPTIONS)(
	IN LPBYTE Packet,
	IN DWORD PacketSize,
	IN LPVOID Reserved,
	IN LPVOID PktContext,
...
typedef DWORD(APIENTRY* LPDHCP_DELETE_CLIENT)(
	IN DWORD IpAddress,
	IN LPBYTE HwAddress,
...
typedef DWORD(APIENTRY* LPDHCP_ENTRY_POINT_FUNC)(
	IN LPWSTR ChainDlls,
