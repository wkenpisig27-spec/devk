...
#endif
typedef /* [helpstring] */
	enum _SERVERXMLHTTP_OPTION { SXH_OPTION_URL = -1,
...
typedef /* [helpstring] */
	enum _SXH_SERVER_CERT_OPTION { SXH_SERVER_CERT_IGNORE_UNKNOWN_CA = 0x100,
...
typedef /* [helpstring] */
	enum _SXH_PROXY_SETTING { SXH_PROXY_SET_DEFAULT = 0,
...
typedef /* [helpstring] */
	enum _SOMITEMTYPE { SOMITEM_SCHEMA = 0x1000,
...
typedef /* [helpstring] */
	enum _SCHEMAUSE { SCHEMAUSE_OPTIONAL = 0,
					  SCHEMAUSE_PROHIBITED = SCHEMAUSE_OPTIONAL + 1,
					  SCHEMAUSE_REQUIRED = SCHEMAUSE_PROHIBITED + 1
	} SCHEMAUSE;

typedef /* [helpstring] */
	enum _SCHEMADERIVATIONMETHOD { SCHEMADERIVATIONMETHOD_EMPTY = 0,
...
typedef /* [helpstring] */
	enum _SCHEMACONTENTTYPE { SCHEMACONTENTTYPE_EMPTY = 0,
...
typedef /* [helpstring] */
	enum _SCHEMAPROCESSCONTENTS { SCHEMAPROCESSCONTENTS_NONE = 0,
...
typedef /* [helpstring] */
	enum _SCHEMAWHITESPACE { SCHEMAWHITESPACE_NONE = -1,
...
typedef /* [helpstring] */
	enum _SCHEMATYPEVARIETY { SCHEMATYPEVARIETY_NONE = -1,
