...
class exception2 : public std::runtime_error, public call_stack {
public:
	exception2(const char* s, unsigned skip = 4 /* -1 for disable call stack*/)
		: std::runtime_error(s ? s : ""), call_stack(skip) {}
};
