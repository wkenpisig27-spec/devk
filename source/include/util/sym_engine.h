...
//	*/
//	static bool stack_trace(CONTEXT *, unsigned skip = 0, const char * fmt = default_fmt());
//	static bool stack_trace(unsigned skip = 1, const char * fmt = default_fmt());
//	static bool stack_trace(sym_engine&, CONTEXT *,
