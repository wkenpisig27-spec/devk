...
public:
  ...
  BOOL Hook() {
	m_hook = SetWindowsHookEx(WH_CBT, (HOOKPROC)GetThunk(), nullptr, GetCurrentThreadId());
	return (BOOL)m_hook;
  }
...
{
  KillTimer(nullptr, m_timerID); // one-shot callback
...
HRESULT CSimpleObj::Post(CONTEXT& contex) {
  ...
  pTimeout->m_timerID = ::SetTimer(nullptr, 0, timeout, (TIMERPROC)pTimeout->GetThunk());
}
//////////////////////////////////////////////////////////////////////////////*/
