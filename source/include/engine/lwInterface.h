...
public:
    ...
    virtual LW_RESULT RegisterVertexShader(DWORD type, const char* file, DWORD binary_flag, const D3DXMACRO* defines = NULL) PURE_METHOD;
...
public:
	...
	virtual IDirect3DTextureX* getMonochromaticTexture( D3DCOLOR colour, const std::string& filterTexture ) PURE_METHOD;
	virtual const char* getTextureOperationDescription( size_t operation ) PURE_METHOD;
};
