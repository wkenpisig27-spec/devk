...
{
    auto vdif = lwVector3(*v1 - *v2);
    return lwVector3SquareMagnitude(&vdif);
}
...
{
	auto r = lwMatrix33Rotate(radian);
	return lwMatrix33Multiply(mat, mat, &r);
}
