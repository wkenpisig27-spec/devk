...
public:
    ...
    void				SetSamplerStateForced(DWORD sampler, D3DSAMPLERSTATETYPE type, DWORD value);
	...
	void				SetCurFrameTick(DWORD dwTick);
    ...
    void	    CaptureScreen(const char* szFilename)const;
...
public:    
    ...
    enum VIEW_TYPE
	{
		VIEW_SCREEN = 0, // ��������Ļ��ΪView
		VIEW_WORLD     , // ��WorldView��������ΪView
		VIEW_UI ,         // ����ͨ����Ҫ��ƽ����ȾView
        VIEW_3DUI ,      // 3D����
	};
...
public:
	...
	D3DCAPSX&	GetOrgCap(){return _d3dCaps;}
...
protected:
    ...
    int                     _nWorldViewWidth;   // ��Ļ����ʾ��Ϸ����ĳߴ�
    int                     _nWorldViewHeight;
    DWORD                   _dwBackgroundColor; // ��Ļ���������ɫ
    DWORD                   _dwClearFlag;
    BOOL                    _bClearTarget;
    BOOL                    _bClearStencil;
    BOOL                    _bClearZBuffer;
	float                   _fWorldViewFOV;
	 float					_fAspect;
	int						_nCurViewType;      // ����SetCurrentView���ظ�����
	float					_fNearClip;
	float					_fFarClip;
	...
	// FPS
	BOOL							_bRealFPS;	// Run as fast as possible (for slower machines)
	DWORD							_dwFPS;
    DWORD							_dwFrameCnt;
    DWORD							_dwLastTick;
