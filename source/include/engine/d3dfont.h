...
class CD3DFont
{
    ...
    IDirect3DDeviceX*       m_pd3dDevice; // A D3DDevice used for rendering
    IDirect3DTextureX*      m_pTexture;   // The d3d texture for this font
    IDirect3DVertexBufferX* m_pVB;        // VertexBuffer for rendering text
...
public:
    ...
    HRESULT InitDeviceObjects( IDirect3DDeviceX* pd3dDevice );
