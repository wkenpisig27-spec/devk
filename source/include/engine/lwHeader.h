...
#define LW_LODWORD( i ) ( (LW_DWORD)( ((LW_INT64)i) & 0xffffffff ) )
#define LW_HIDWORD( i ) ( (LW_DWORD)( (LW_DWORD)(((LW_INT64)i) >> 32) & 0xffffffff) )
...
// Debug output macro - outputs to debugger in debug builds, no-op in release
#ifdef _DEBUG
#define LW_DEBUG_OUTPUT(fmt, ...) \
    { \
        char _dbg_buf[512]; \
...
#else
#define LW_DEBUG_OUTPUT(fmt, ...) ((void)0)
#endif
