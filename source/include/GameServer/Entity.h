...
public:
	...
	void SetRadius(const int& lRadius) { m_shape.radius = lRadius; }
	const int& GetRadius() const { return m_shape.radius; }
...
private:
	...
	bool EdgeOverlap(int& xdist, int& ydist);
	bool ObstacleOverlap(int& xdist, int& ydist);
