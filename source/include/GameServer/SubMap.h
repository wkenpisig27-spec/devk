...
public:
	...
	bool CheckRun(void);
	void DealActivePlayer(std::string& function); // 2006.10.12wsj处理乱斗白银城的胜者.
...
private:
	...
	// 范围内搜索 (members below were in an anonymous struct, removed for GCC compatibility)
