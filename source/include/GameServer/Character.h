...
public:
	...
	// B6: Character opcode registry handlers
	static bool OpcodeHandle_CmBossTimerRequest(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmRank(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmCancelExit(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmCheckPing(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmEndAction(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmDieReturn(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmMisLog(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmMisLogInfo(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmMisLogClear(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmMapMask(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmSay(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmStallSearch(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmSynAttr(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmRefreshData(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmReadbookStart(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmReadbookClose(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmKitbagCheck(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmKitbagUnlock(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmBoatGetinfo(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmStallAlldata(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmBeginAction(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmForge(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmBoatCancel(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmCreateBoat(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmUpdateboatPart(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmStallOpen(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmStallClose(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmKitbagAutolock(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmKitbagLock(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmUpdatehair(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmSkillupgrade(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmTeamFightAsk(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmTeamFightAsr(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmItemRepairAsk(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmItemRepairAsr(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmStallBuy(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmBoatLuanch(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmBoatBagsel(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmBoatSelect(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmEntityEvent(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmItemForgeCanaction(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmValidateSlotItem(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmItemForgeAsk(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmItemForgeAsr(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmItemLotteryAsk(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmLifeskillAsk(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmLifeskillAsr(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmKitbagExpand(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmPing(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmTigerStart(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmTigerStop(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmStoreOpenAsk(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmStoreListAsk(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmStoreBuyAsk(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmStoreChangeAsk(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmStoreQuery(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmStoreVip(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmStoreClose(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmRequestTalkOrTrade(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmKitbagtempSync(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmItemLockAsk(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmItemUnlockAsk(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmGameRequestPin(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmChartradeRequest(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmChartradeAccept(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmChartradeReject(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmChartradeCancel(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmChartradeItem(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmChartradeMoney(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmChartradeValidatedata(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmChartradeValidate(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmVolunterOpen(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmVolunterList(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmVolunterAdd(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmVolunterDel(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmVolunterSel(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmVolunterAsr(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmMasterInvite(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmMasterAsr(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmMasterDel(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmPrenticeDel(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmPrenticeInvite(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmPrenticeAsr(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_PmGuildbank(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_PmPushToGuildbank(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_TmChangePersoninfo(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmGuildPerm(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmGuildPutname(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmGuildTryfor(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmGuildTryforcfm(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmGuildListtryplayer(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmGuildApprove(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmGuildReject(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmGuildKick(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmGuildLeave(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmGuildDisband(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmGuildMotto(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_PmGuildDisband(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmGuildChallenge(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmGuildLeizhu(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmSay2camp(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmGmSend(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmGmRecv(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmPkCtrl(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmCheatCheck(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmBidup(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmAntiindulgence(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmRequestDropRate(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmRequestExpRate(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmGetPlayerBattlePoint(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
	static bool OpcodeHandle_CmRequestChestPreview(void* ctx, dbc::DataSocket* sock, dbc::RPacket& pk);
