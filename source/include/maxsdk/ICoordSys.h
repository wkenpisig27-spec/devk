...
typedef /* [public] */
	enum __MIDL___MIDL_itf_ICoordSys_0000_0001 { eGcsNew = 0,
												 eGcsContainer = 1,
												 eGcsData = 2
	} GcsChunkType;

typedef /* [public] */
	enum __MIDL___MIDL_itf_ICoordSys_0000_0002 { eGcsMax = 0,
												 eGcsMat = 1
	} GcsFileIOType;

typedef /* [public] */
	enum __MIDL___MIDL_itf_ICoordSys_0000_0003 { eGcsFont = 0,
												 eGcsScene = 1,
												 eGcsImport = 2,
												 eGcsExport = 3,
												 eGcsHelp = 4,
