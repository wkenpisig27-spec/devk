...
enum DisplayState { kNoRedrawNeeded,
					kFullRedrawNeeded,
					kPostRedrawNeeded };
...
public:
	...
	virtual DisplayState MouseEntersObject(TimeValue t, ViewExp* pVpt, IPoint2& m, ManipHitData* pHitData) { return kNoRedrawNeeded; }
	virtual DisplayState MouseLeavesObject(TimeValue t, ViewExp* pVpt, IPoint2& m, ManipHitData* pHitData) { return kNoRedrawNeeded; }
...
public:
	...
	BaseInterface* GetInterface(Interface_ID id) {
		if (id == SIMPLE_MANIP_INTERFACE)
			return (ISimpleManipulator*)this;
		else
