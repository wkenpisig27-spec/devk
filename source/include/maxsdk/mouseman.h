...
public:
	...
	CoreExport void SetMouseWindProcCallback(WNDPROC pMouseWindProc) { mpMouseWindProc = pMouseWindProc; }
	...
	WNDPROC GetMouseWindProcCallback() const { return mpMouseWindProc; }
