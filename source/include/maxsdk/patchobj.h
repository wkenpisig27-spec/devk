...
public:
	EP_BindMouseProc(PatchObject* spl, IObjParam* i) {
		pobj = spl;
		ip = i;
	}
	int proc(
...
public:
	EP_BindCMode(PatchObject* spl, IObjParam* i) : fgProc((ReferenceTarget*)spl), eproc(spl, i) { pobj = spl; }
...
public:
	EP_ExtrudeMouseProc(PatchObject* o, IObjParam* i) : moveTrans(i) {
		po = o;
		ip = i;
	}
...
public:
	EP_ExtrudeCMode(PatchObject* o, IObjParam* i) : fgProc((ReferenceTarget*)o), mouseProc(&eproc, o, i), eproc(o, i) { po = o; }
	int Class() { return MODIFY_COMMAND; }
...
public:
	EP_NormalFlipMouseProc(PatchObject* o, IObjParam* i) {
		po = o;
		ip = i;
	}
	BOOL HitTest(ViewExp* vpt, IPoint2* p, int type, int flags, int subType);
...
public:
	EP_NormalFlipCMode(PatchObject* o, IObjParam* i) : fgProc((ReferenceTarget*)o), eproc(o, i) { po = o; }
	int Class() { return MODIFY_COMMAND; }
...
public:
	EP_BevelMouseProc(PatchObject* o, IObjParam* i) : moveTrans(i) {
		po = o;
		ip = i;
	}
	int proc(HWND hwnd, int msg, int point, int flags, IPoint2 m);
...
public:
	EP_BevelCMode(PatchObject* o, IObjParam* i) : fgProc((ReferenceTarget*)o), mouseProc(&eproc, o, i), eproc(o, i) { po = o; }
	int Class() { return MODIFY_COMMAND; }
...
public:
	EP_CreateVertMouseProc(PatchObject* mod, IObjParam* i) {
		po = mod;
		mpIP = i;
	}
	int proc(HWND hwnd, int msg, int point, int flags, IPoint2 m);
...
public:
	EP_CreateVertCMode(PatchObject* mod, IObjParam* i) : fgProc((ReferenceTarget*)mod), proc(mod, i) { po = mod; }
	int Class() { return MODIFY_COMMAND; }
...
public:
	...
	EP_CreatePatchCMode(PatchObject* mod, IObjParam* i) : fgProc((ReferenceTarget*)mod), proc(mod, i) { po = mod; }
	int Class() { return MODIFY_COMMAND; }
...
public:
	...
	EP_VertWeldMouseProc(PatchObject* mod, IObjParam* i) {
		po = mod;
		mpIP = i;
	}
	BOOL HitTest(ViewExp* vpt, IPoint2* p, int type, int flags, int subType);
...
public:
	...
	EP_VertWeldCMode(PatchObject* mod, IObjParam* i) : fgProc((ReferenceTarget*)mod), proc(mod, i) { po = mod; }
	int Class() { return MODIFY_COMMAND; }
...
class POPickPatchAttach : public PickModeCallback,
...
public:
	...
	CoreExport void SetShowVerts(BOOL sw) {
		if (sw)
			patch.SetDispFlag(DISP_VERTS);
		else
			patch.ClearDispFlag(DISP_VERTS);
	}
