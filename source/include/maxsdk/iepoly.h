...
enum ePolySelLevel { EP_SL_OBJECT,
					 EP_SL_VERTEX,
					 EP_SL_EDGE,
					 EP_SL_BORDER,
					 EP_SL_FACE,
...
enum epolyParameters { ep_by_vertex,
...
enum epolyCommandMode { epmode_create_vertex,
						epmode_create_edge,
						epmode_create_face,
						epmode_divide_edge,
						epmode_divide_face,
...
enum epolyEnumList { epolyEnumButtonOps,
...
enum ePolyMethods { epfn_hide,
					...
					/*epfn_apply_delta,*/ epfn_propagate_component_flags,
