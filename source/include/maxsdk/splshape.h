...
class SSPickSplineAttach : public PickModeCallback,
...
public:
	SSOutlineCMode(SplineShape* ss, IObjParam* i) : fgProc(ss), mouseProc(&eproc, ss, i), eproc(ss, i) { this->ss = ss; }
...
public:
	SSFilletCMode(SplineShape* ss, IObjParam* i) : fgProc(ss), mouseProc(&eproc, ss, i), eproc(ss, i) { this->ss = ss; }
...
public:
	SSChamferCMode(SplineShape* ss, IObjParam* i) : fgProc(ss), mouseProc(&eproc, ss, i), eproc(ss, i) { this->ss = ss; }
...
public:
	SSSegBreakMouseProc(SplineShape* spl, IObjParam* i) {
		ss = spl;
		ip = i;
	}
	int proc(
...
public:
	SSSegBreakCMode(SplineShape* spl, IObjParam* i) : fgProc(spl), eproc(spl, i) { ss = spl; }
...
public:
	SSSegRefineMouseProc(SplineShape* spl, IObjParam* i) {
		ss = spl;
		ip = i;
	}
	int proc(
...
public:
	SSSegRefineCMode(SplineShape* spl, IObjParam* i) : fgProc(spl), eproc(spl, i) { ss = spl; }
...
public:
	SSCrossInsertMouseProc(SplineShape* spl, IObjParam* i) {
		ss = spl;
		ip = i;
	}
	int proc(
...
public:
	SSCrossInsertCMode(SplineShape* spl, IObjParam* i) : fgProc(spl), eproc(spl, i) { ss = spl; }
...
public:
	SSVertConnectMouseProc(SplineShape* spl, IObjParam* i) {
		ss = spl;
		ip = i;
	}
	int proc(
...
public:
	SSVertConnectCMode(SplineShape* spl, IObjParam* i) : fgProc(spl), eproc(spl, i) { ss = spl; }
...
public:
	SSVertInsertMouseProc(SplineShape* spl, IObjParam* i) {
		ss = spl;
		ip = i;
	}
	int proc(
...
public:
	SSVertInsertCMode(SplineShape* spl, IObjParam* i) : fgProc(spl), eproc(spl, i) {
		ss = spl;
		control = -1;
	}
...
public:
	SSCreateLineCMode(SplineShape* spl, IObjParam* i) : fgProc(spl), eproc(spl, i) { ss = spl; }
...
public:
	SSBooleanMouseProc(SplineShape* spl, IObjParam* i) {
		ss = spl;
		ip = i;
	}
	int proc(
...
public:
	SSBooleanCMode(SplineShape* spl, IObjParam* i) : fgProc(spl), eproc(spl, i) { ss = spl; }
...
public:
	SSTrimMouseProc(SplineShape* spl, IObjParam* i) {
		ss = spl;
		ip = i;
	}
	int proc(
...
public:
	SSTrimCMode(SplineShape* spl, IObjParam* i) : fgProc(spl), eproc(spl, i) { ss = spl; }
...
public:
	SSExtendMouseProc(SplineShape* spl, IObjParam* i) {
		ss = spl;
		ip = i;
	}
	int proc(
...
public:
	SSExtendCMode(SplineShape* spl, IObjParam* i) : fgProc(spl), eproc(spl, i) { ss = spl; }
...
public:
	SSBindMouseProc(SplineShape* spl, IObjParam* i) {
		ss = spl;
		ip = i;
	}
	int proc(
...
public:
	SSBindCMode(SplineShape* spl, IObjParam* i) : fgProc(spl), eproc(spl, i) { ss = spl; }
...
public:
	SSRefineConnectMouseProc(SplineShape* spl, IObjParam* i) {
		ss = spl;
		ip = i;
	}
	int proc(
...
public:
	SSRefineConnectCMode(SplineShape* spl, IObjParam* i) : fgProc(spl), eproc(spl, i) { ss = spl; }
