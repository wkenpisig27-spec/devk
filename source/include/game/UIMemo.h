...
protected:
	...
	std::string _strItemEx[MEMO_MAX_ITEM]; // 额外数据,不显示
...
public:
	bool TryGetFirstClickableNavPayload(std::string& outPayload) const;
	bool TryGetMissionAutoRoutePayload(std::string& outPayload) const;
