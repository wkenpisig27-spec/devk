...
public:
	...
	bool IsRunning();
	void OnValidateSlotSuccess(char chSlotIndex, short sGridID);
...
private:
	...
	static void _evtUseCommandEvent(CCommandObj* pSender, bool& isUse);
	static void _evtForgeSlotUseEvent(CCommandObj* pSender, bool& isUse);
