...
public:
	...
	void OnValidateSlotSuccess(char chFormType, char chSlotIndex, short sGridID);
...
private: /*Call back Functions*/
	...
	static void _evtInventoryUseEvent(CCommandObj* pSender, bool& isUse);

	CForm* frmMakeEquip;

private:
	static void _evtSlotUseEvent(CCommandObj* pSender, bool& isUse); /*Help Functions:*/
	void ClearEquips();
