...
BOOL CCharMission::MisInit(char* pszBuf) {
	T_B int nEdition(-1), nData1(0), nData2(0), nData3(0), nData4(0), nData5(0), nData6(0),
...
BOOL CCharMission::MisInitTrigger(char* pszBuf) {
	T_B int nEdition(-1), nData1(0), nData2(0), nData3(0), nData4(0), nData5(0),
...
void CCharMission::KillWare(USHORT sWareID) {
	T_B for (int i = 0; i < m_byNumTrigger; i++) {
