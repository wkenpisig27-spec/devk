...
void CSkillRecord::RefreshPrivateData() {
	...
	case enumSKILL_TYPE_SELF:
		_eSelectCha = enumSC_SELF;
		break;
	case enumSKILL_TYPE_TEAM:
		_eSelectCha = enumSC_TEAM;
		break;
	case enumSKILL_TYPE_PLAYER_DIE:
		_eSelectCha = enumSC_PLAYER_ASHES;
		break;
	case enumSKILL_TYPE_REPAIR:
		_eSelectCha = enumSC_MONS_REPAIRABLE;
		break;
	case enumSKILL_TYPE_TREE:
		_eSelectCha = enumSC_MONS_TREE;
		break;
	case enumSKILL_TYPE_MINE:
		_eSelectCha = enumSC_MONS_MINE;
		break;
	case enumSKILL_TYPE_FISH:
		_eSelectCha = enumSC_MONS_FISH;
		break;
	case enumSKILL_TYPE_SALVAGE:
		_eSelectCha = enumSC_MONS_DBOAT;
		break;
	...
	case enumSKILL_TYPE_ENEMY:
		_eSelectCha = enumSC_ENEMY;
		break;
	case enumSKILL_TYPE_TRADE:
		_eSelectCha = enumSC_NONE;
		break;
	};
...
//---------------------------------------------------------------------------
CSkillRecordSet* CSkillRecordSet::_Instance = nullptr;
