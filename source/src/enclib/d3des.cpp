...
static void scrunch(unsigned char*, unsigned int*);
static void unscrun(unsigned int*, unsigned char*);
static void desfunc(unsigned int*, unsigned int*);
static void cookey(unsigned int*);
...
void des2key(unsigned char* hexkey /* unsigned char[16] */, short mode) /* stomps on Kn3 too */
{
	short revmod;
...
void Ddes(unsigned char* from, unsigned char* into) /* unsigned char[8] */
{
	unsigned int work[2];
...
void D2des(unsigned char* from /* unsigned char[16] */, unsigned char* into /* unsigned char[16] */) {
	unsigned int *right, *l1, swap;
	unsigned int leftt[2], bufR[2];
...
void makekey(char* aptr /* NULL-terminated  */, unsigned char* kptr /* unsigned char[8] */) {
...
void make2key(char* aptr /* NULL-terminated   */, unsigned char* kptr /* unsigned char[16] */) {
	register unsigned char* store;
	register int first, i;
	unsigned int savek[96];
...
void cp2key(unsigned int* into /* unsigned int[64] */) {
	register unsigned int *from, *endp;
...
void use2key(unsigned int* from /* unsigned int[64] */) /* stomps on Kn3 too */
{
	register unsigned int *to, *endp;
...
void des3key(unsigned char* hexkey /* unsigned char[24] */, short mode) {
...
void cp3key(unsigned int* into /* unsigned int[96] */) {
	register unsigned int *from, *endp;
...
void use3key(unsigned int* from /* unsigned int[96] */) {
	register unsigned int *to, *endp;
...
static void D3des(unsigned char* from /* unsigned char[24] */, unsigned char* into /* unsigned char[24] */) /* amateur theatrics */
{
	unsigned int swap, leftt[2], middl[2], right[2];
...
void make3key(char* aptr /* NULL-terminated   */, unsigned char* kptr /* unsigned char[24] */) {
	register unsigned char* store;
	register int first, i;
	unsigned int savek[96];
