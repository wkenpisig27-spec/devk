...
//	{
//		if(pctx==nullptr) g_os << "pctx = nullptr, stack_first return false!\n";
//		else           g_os << "bad Read Ptr, stack_first return false!\n";
//		return false;
//	}
//	if (!check())
//	{
//		g_os << "check() = false, stack_first return false!\n";
//		return false;
//	}
//	if (!m_pframe)
//	{
...
//}
//
// bool sym_engine::stack_trace(CONTEXT * pctx, unsigned skip, const char * fmt)
//{
//	if (!fmt) return false;
//	sym_engine sym(0);
//	return stack_trace(sym, pctx, skip, fmt);
//}
//
///////////////////////////////////////////////
...
//}
//
// bool sym_engine::stack_trace(unsigned skip, const char * fmt)
//{
//	if (!fmt) return false;
//
...
//	sym_engine sym(0);
//	stack_trace(sym, &ctx, skip, fmt);
//	return true;
//}
//
// bool sym_engine::stack_trace(sym_engine& sym,
...
//		std::string	strfile;
//		LG_GetDir(strfile);
//		const char	*cszfile = strfile.c_str();
//		size_t	tlen = strlen(cszfile);
//		if (tlen > 0)
//		{
//			if (cszfile[tlen - 1] != '\\' && cszfile[tlen - 1] != '\/')
//				strfile += "\\";
//		}
//		strfile += "exception2.txt";
//		g_os.open(strfile.c_str(), ios_base::out);
//		if(!g_os.is_open())
//		{
//			return false;
//		}
//        g_os << "open exception file ok!\n";
//	}
//
//	g_pos = &g_os;
//
//	std::ofstream &os = g_os;
//
//    // g_os << "enter stack_first!\n";
//    if (!sym.stack_first(pctx))
//	{
//		g_os << "stack_first return false!\n";
//		return false;
//	}
//
//	char buf [512] = {0};
