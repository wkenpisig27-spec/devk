...
CProgressBar::CProgressBar(CForm& frmOwn, eStyle style)
	: CCompent(frmOwn), _bActiveMouse(false), _style(style), _pTex(nullptr), _nFlash(1), _eHintStyle(hsHintPercent), evtMouseDown(nullptr), evtTimeArrive(nullptr), _dwEndTime(0), _dwStartTime(0) {
