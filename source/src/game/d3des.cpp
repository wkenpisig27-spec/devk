...
void cp2key(unsigned long* into /* unsigned long[64] */) {
	register unsigned long *from, *endp;
...
void use2key(unsigned long* from /* unsigned long[64] */) /* stomps on Kn3 too */
{
	register unsigned long *to, *endp;
...
void cp3key(unsigned long* into /* unsigned long[96] */) {
	register unsigned long *from, *endp;
...
void use3key(unsigned long* from /* unsigned long[96] */) {
	register unsigned long *to, *endp;
