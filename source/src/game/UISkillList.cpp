...
CSkillList::CSkillList(CForm& frmOwn)
	: CCompent(frmOwn), _nShowFirst(0), _nShowLast(0), _nRowHeight(36), _nShowCount(0), _dwFontColor(COLOR_BLACK), _nLeftMargin(0), _nTopMargin(0), _nRightMargin(0), _nBottomMargin(0), _nFontStart(40), _nFontYOff(0), _nSelectIndex(0), _nUnitHeight(32), _nUnitWidth(32), _nDragIndex(-1), _IsShowUpgrade(true), evtUpgrade(nullptr), _nMouseUpgradeID(-1) {
	// _IsFocus = true;
