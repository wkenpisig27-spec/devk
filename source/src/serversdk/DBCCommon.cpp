...
#else
	// On Linux, atomic builtins always have acquire semantics on x86/x64
	g_isSuportAcquire = 1;
#endif
	return true;
}
...
LLong InterLockedLongLong::CompareAssign(LLong Comperand, LLong newval) // ���ʱ��Ÿ�ֵ,The return value is the initial value
{
	if (g_isSuportAcquire > 0) {
